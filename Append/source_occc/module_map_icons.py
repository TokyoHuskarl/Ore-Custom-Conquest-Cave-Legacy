...
map_icons = [
  ...
  #occc addition
  ("town_big",mcn_no_shadow,"map_town_swadia", 0.35,0),
  ("town_big_snowy",mcn_no_shadow,"map_town_vaegir_khudan", 0.35,0),
  ("town_tihr",mcn_no_shadow,"map_town_nord_tihr", 0.35,0),
  ("town_rome",mcn_no_shadow,"roman_town_b", 0.35,0),
...
##occc start
  ...
  ## CC-D begin: add extra icon imported from difor v0.058
  ("swadia_king",0,"dedal_map_swadia_king_a", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("vaegir_king",0,"flagbearer_b_napo", avatar_scale, snd_footstep_grass, 0.15, 0.173, 0),
  ("khergit_king",0,"dedal_map_khergit_king_a", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("nord_king",0,"dedal_map_nordic_king_a", avatar_scale, snd_footstep_grass, 0.15, 0.173, 0),
  ("rhodok_king",0,"legat", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("sarran_king",0,"dedal_map_sarranid_king_a", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("dk_king",0,"map_darkknight_lord", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("hellas_king",0,"flagbearer_a", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("taikou_king",0,"horseman_black", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("sunset_king",0,"dedal_map_nordic_king_a", avatar_scale, snd_footstep_grass, 0.15, 0.173, 0),
  ("old_rhodok_king",0,"dedal_map_rhodok_king_a", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("old_vaegir_king",0,"dedal_map_vaegir_king_a", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("ring_king",0,"flagbearer_a", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("albion_king",0,"dedal_map_swadia_king_a", avatar_scale, snd_gallop, 0.15, 0.173, 0),

  ("swadia_lord",0,"dedal_map_swadia_lord_a", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("vaegir_lord",0,"knight_a_napo", avatar_scale, snd_footstep_grass, 0.15, 0.173, 0),
  ("khergit_lord",0,"dedal_map_khergit_lord_a", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("nord_lord",0,"dedal_map_nordic_lord_a", avatar_scale, snd_footstep_grass, 0.15, 0.173, 0),
  ("rhodok_lord",0,"pretorian_eques", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("sarran_lord",0,"dedal_map_sarranid_lord_a", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("dk_lord",0,"map_darkknight_lord", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("hellas_lord",0,"flagbearer_a", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("taikou_lord",0,"horseman_momo", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("sunset_lord",0,"dedal_map_nordic_lord_a", avatar_scale, snd_footstep_grass, 0.15, 0.173, 0),
  ("old_rhodok_lord",0,"dedal_map_rhodok_lord_a", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("old_vaegir_lord",0,"dedal_map_vaegir_lord_a", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("ring_lord",0,"flagbearer_a", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("albion_lord",0,"dedal_map_nordic_lord_a", avatar_scale, snd_gallop, 0.15, 0.173, 0),

  ("archer_bandit",0,"dedal_map_forest_bandit", avatar_scale, snd_footstep_grass, 0.15, 0.173, 0),
  ("sea_raider",0,"dedal_map_sea_raider", avatar_scale, snd_footstep_grass, 0.15, 0.173, 0),
  ("horse_bandit",0,"dedal_map_mountain_bandit", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("slave_caravan",0,"map_slave_caravan", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ## CC-D end 

  ("icon_expantion_1",0,"map_slave_caravan", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("icon_expantion_2",0,"map_slave_caravan", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("icon_expantion_3",0,"map_slave_caravan", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("icon_expantion_4",0,"map_slave_caravan", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("icon_expantion_5",0,"map_slave_caravan", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("icon_expantion_6",0,"map_slave_caravan", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("icon_expantion_7",0,"map_slave_caravan", avatar_scale, snd_gallop, 0.15, 0.173, 0),
...
#  ("banner_144",0,"map_flag_g18", banner_scale,0),  # g18 = e11
  ("banner_144",0,"map_flag_g19", banner_scale,0),
  ("banner_145",0,"map_flag_g20", banner_scale,0),
  ("banner_146",0,"map_flag_g21", banner_scale,0),
  ("banner_147",0,"map_flag_yours01", banner_scale,0),
  ("banner_148",0,"map_flag_yours02", banner_scale,0),
  ("banner_149",0,"map_flag_yours03", banner_scale,0),
  ("banner_150",0,"map_flag_yours04", banner_scale,0),
  ("banner_151",0,"map_flag_jp01", banner_scale,0),
  ("banner_152",0,"map_flag_jp02", banner_scale,0),
  ("banner_153",0,"map_flag_jp03", banner_scale,0),
  ("banner_154",0,"map_flag_jp04", banner_scale,0),
  ("banner_155",0,"map_flag_jp05", banner_scale,0),
  ("banner_156",0,"map_flag_jp06", banner_scale,0),
  ("banner_157",0,"map_flag_jp07", banner_scale,0),
  ("banner_158",0,"map_flag_jp08", banner_scale,0),
  ("banner_159",0,"map_flag_jp09", banner_scale,0),
  ("banner_160",0,"map_flag_jp10", banner_scale,0),
  ("banner_161",0,"map_flag_jp11", banner_scale,0),
  ("banner_162",0,"map_flag_jp12", banner_scale,0),
  ("banner_163",0,"map_flag_jp13", banner_scale,0),
  ("banner_164",0,"map_flag_jp14", banner_scale,0),
  ("banner_165",0,"map_flag_jp15", banner_scale,0),
  ("banner_166",0,"map_flag_jp16", banner_scale,0),
  ("banner_167",0,"map_flag_jp17", banner_scale,0),
  ("banner_168",0,"map_flag_jp18", banner_scale,0),
  ("banner_169",0,"map_flag_jp19", banner_scale,0),
  ("banner_170",0,"map_flag_jp20", banner_scale,0),
  ("banner_171",0,"map_flag_jp21", banner_scale,0),

## CC-D end
  
  ("map_flag_kingdom_a",0,"map_flag_kingdom_a", banner_scale,0),
  ("map_flag_kingdom_b",0,"map_flag_kingdom_french", banner_scale,0),
  ("map_flag_kingdom_c",0,"map_flag_kingdom_c", banner_scale,0),
  ("map_flag_kingdom_d",0,"map_flag_kingdom_rome", banner_scale,0),
  ("map_flag_kingdom_e",0,"map_flag_kingdom_e", banner_scale,0),
  ("map_flag_kingdom_f",0,"map_flag_kingdom_f", banner_scale,0),
  ("map_flag_kingdom_darkknight",0,"map_flag_03", banner_scale,0),
  ("map_flag_kingdom_hellas",0,"map_flag_kingdom_hellas", banner_scale,0),
  ("map_flag_kingdom_taikou",0,"map_flag_kingdom_taikou", banner_scale,0),
  ("map_flag_kingdom_sunset",0,"map_flag_kingdom_f", banner_scale,0),
  ("map_flag_kingdom_b_old",0,"map_flag_kingdom_b", banner_scale,0),
  ("map_flag_kingdom_d_old",0,"map_flag_kingdom_d", banner_scale,0),
