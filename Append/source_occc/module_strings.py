...
#  ("relation_plus_90",  "                   Devoted"),
  ...
  #occc start
  ("occc_lumber", "lumber camp"),
  ("occc_mining", "mining camp"),
...
# strings for opinion
#### Get NPC dislike begin
#  ("npc_morale_report", "I'm {s6} your choice of companions, {s7} your style of leadership, and {s8} the general state of affairs"), 
  ("npc_morale_report", "I'm {s6} your choice of companions, {s7} your style of leadership, and {s8} the general state of affairs^^{s10})"),
#### Get NPC dislike end
  ("happy", "happy about"),
...
## ADD Start
  ("npc17_intro", "Nice to meet you. I'm a traveller"),
  ("npc18_intro", "Nice to meet you. I'm a traveller"),
  ("npc19_intro", "Nice to meet you. I'm a traveller"),
  ("npc20_intro", "Nice to meet you. I'm a traveller"),
  ("npc21_intro", "Nice to meet you. I'm a traveller"),
  ("npc22_intro", "Nice to meet you. I'm a traveller"),
  ("npc23_intro", "Nice to meet you. I'm a traveller"),
  ("npc24_intro", "Nice to meet you. I'm a traveller"),
## ADD Start
...
## ADD Start
  ("npc17_intro_response_1", "Do you feel the wind is blowing on Calradia?"),
  ("npc18_intro_response_1", "Do you feel the wind is blowing on Calradia?"),
  ("npc19_intro_response_1", "Do you feel the wind is blowing on Calradia?"),
  ("npc20_intro_response_1", "Do you feel the wind is blowing on Calradia?"),
  ("npc21_intro_response_1", "Do you feel the wind is blowing on Calradia?"),
  ("npc22_intro_response_1", "Do you feel the wind is blowing on Calradia?"),
  ("npc23_intro_response_1", "Do you feel the wind is blowing on Calradia?"),
  ("npc24_intro_response_1", "Do you feel the wind is blowing on Calradia?"),
## ADD Start
...
## ADD Start
  ("npc17_intro_response_2", "You are interesting."),
  ("npc18_intro_response_2", "You are interesting."),
  ("npc19_intro_response_2", "You are interesting."),
  ("npc20_intro_response_2", "You are interesting."),
  ("npc21_intro_response_2", "You are interesting."),
  ("npc22_intro_response_2", "You are interesting."),
  ("npc23_intro_response_2", "You are interesting."),
  ("npc24_intro_response_2", "You are interesting."),
## ADD Start
...
## ADD Start
  ("npc17_backstory_a", "I have travelled with Calradian wind leading."),
  ("npc18_backstory_a", "I have travelled with Calradian wind leading."),
  ("npc19_backstory_a", "I have travelled with Calradian wind leading."),
  ("npc20_backstory_a", "I have travelled with Calradian wind leading."),
  ("npc21_backstory_a", "I have travelled with Calradian wind leading."),
  ("npc22_backstory_a", "I have travelled with Calradian wind leading."),
  ("npc23_backstory_a", "I have travelled with Calradian wind leading."),
  ("npc24_backstory_a", "I have travelled with Calradian wind leading."),
...
## ADD Start
  ("npc17_backstory_b","I have travelled with Calradian wind leading."),
  ("npc18_backstory_b","I have travelled with Calradian wind leading."),
  ("npc19_backstory_b","I have travelled with Calradian wind leading."),
  ("npc20_backstory_b","I have travelled with Calradian wind leading."),
  ("npc21_backstory_b","I have travelled with Calradian wind leading."),
  ("npc22_backstory_b","I have travelled with Calradian wind leading."),
  ("npc23_backstory_b","I have travelled with Calradian wind leading."),
  ("npc24_backstory_b","I have travelled with Calradian wind leading."),
## ADD Start
...
## ADD Start
  ("npc17_backstory_c","And Calradian wind may lead us here..."),
  ("npc18_backstory_c","And Calradian wind may lead us here..."),
  ("npc19_backstory_c","And Calradian wind may lead us here..."),
  ("npc20_backstory_c","And Calradian wind may lead us here..."),
  ("npc21_backstory_c","And Calradian wind may lead us here..."),
  ("npc22_backstory_c","And Calradian wind may lead us here..."),
  ("npc23_backstory_c","And Calradian wind may lead us here..."),
  ("npc24_backstory_c","And Calradian wind may lead us here..."),
## ADD Start
...
## ADD Start
  ("npc17_backstory_later","I'm traveller as before."),
  ("npc18_backstory_later","I'm traveller as before."),
  ("npc19_backstory_later","I'm traveller as before."),
  ("npc20_backstory_later","I'm traveller as before."),
  ("npc21_backstory_later","I'm traveller as before."),
  ("npc22_backstory_later","I'm traveller as before."),
  ("npc23_backstory_later","I'm traveller as before."),
  ("npc24_backstory_later","I'm traveller as before."),
...
## ADD Start
  ("npc17_backstory_response_1","Calradian wind blows with me. Come and join us."),
  ("npc18_backstory_response_1","Calradian wind blows with me. Come and join us."),
  ("npc19_backstory_response_1","Calradian wind blows with me. Come and join us."),
  ("npc20_backstory_response_1","Calradian wind blows with me. Come and join us."),
  ("npc21_backstory_response_1","Calradian wind blows with me. Come and join us."),
  ("npc22_backstory_response_1","Calradian wind blows with me. Come and join us."),
  ("npc23_backstory_response_1","Calradian wind blows with me. Come and join us."),
  ("npc24_backstory_response_1","Calradian wind blows with me. Come and join us."),
...
## ADD Start
  ("npc17_backstory_response_2","Sorry, I'm just saying. Bye."),
  ("npc18_backstory_response_2","Sorry, I'm just saying. Bye."),
  ("npc19_backstory_response_2","Sorry, I'm just saying. Bye."),
  ("npc20_backstory_response_2","Sorry, I'm just saying. Bye."),
  ("npc21_backstory_response_2","Sorry, I'm just saying. Bye."),
  ("npc22_backstory_response_2","Sorry, I'm just saying. Bye."),
  ("npc23_backstory_response_2","Sorry, I'm just saying. Bye."),
  ("npc24_backstory_response_2","Sorry, I'm just saying. Bye."),
...
## ADD Start
  ...
  ("npc17_signup_2","My skills must be useful for you."),
  ("npc18_signup_2","My skills must be useful for you."),
  ("npc19_signup_2","My skills must be useful for you."),
  ("npc20_signup_2","My skills must be useful for you."),
  ("npc21_signup_2","My skills must be useful for you."),
  ("npc22_signup_2","My skills must be useful for you."),
  ("npc23_signup_2","My skills must be useful for you."),
  ("npc24_signup_2","My skills must be useful for you."),
  ...
  ("npc17_signup_response_1","Let's go."),
  ("npc18_signup_response_1","Let's go."),
  ("npc19_signup_response_1","Let's go."),
  ("npc20_signup_response_1","Let's go."),
  ("npc21_signup_response_1","Let's go."),
  ("npc22_signup_response_1","Let's go."),
  ("npc23_signup_response_1","Let's go."),
  ("npc24_signup_response_1","Let's go."),
...
#11
  ...
  ("npc17_signup_response_2","My mind changed. Bye."),
  ("npc18_signup_response_2","My mind changed. Bye."),
  ("npc19_signup_response_2","My mind changed. Bye."),
  ("npc20_signup_response_2","My mind changed. Bye."),
  ("npc21_signup_response_2","My mind changed. Bye."),
  ("npc22_signup_response_2","My mind changed. Bye."),
  ("npc23_signup_response_2","My mind changed. Bye."),
  ("npc24_signup_response_2","My mind changed. Bye."),
  ...
  ("npc17_payment","{!}."),
  ("npc18_payment","I need {reg3} denar for the deposit. Ok?"),
  ("npc19_payment","I need {reg3} denar for the deposit. Ok?"),
  ("npc20_payment","I need {reg3} denar for the deposit. Ok?"),
  ("npc21_payment","I need {reg3} denar for the deposit. Ok?"),
  ("npc22_payment","{!}."),
  ("npc23_payment","I need {reg3} denar for the deposit. Ok?"),
  ("npc24_payment","I need {reg3} denar for the deposit. Ok?"),
...
("npc18_payment_response","Here you are. "),
("npc19_payment_response","Here you are. "),
("npc20_payment_response","Here you are. "),
("npc21_payment_response","Here you are. "),
("npc22_payment_response","{!}."),
("npc23_payment_response","Here you are. "),
("npc24_payment_response","Here you are. "),
  ...
  ("npc17_morality_speech","I don't become to like {s21}..."),
("npc18_morality_speech","{!}[No secondary moral code]"),
("npc19_morality_speech","{!}[No secondary moral code]"),
("npc20_morality_speech","I don't become to like {s21}..."),
("npc21_morality_speech","{!}[No secondary moral code]"),
("npc22_morality_speech","{!}[No secondary moral code]"),
("npc23_morality_speech","{!}[No secondary moral code]"),
("npc24_morality_speech","{!}[No secondary moral code]"),
  ...
  ("npc17_2ary_morality_speech","{s21} is a necessary evil, I understand, but..."),
("npc18_2ary_morality_speech","{s21} is a necessary evil, I understand, but..."),
("npc19_2ary_morality_speech","{s21} is a necessary evil, I understand, but..."),
("npc20_2ary_morality_speech","{s21} is a necessary evil, I understand, but..."),
("npc21_2ary_morality_speech","{s21} is a necessary evil, I understand, but..."),
("npc22_2ary_morality_speech","{s21} is a necessary evil, I understand, but..."),
("npc23_2ary_morality_speech","{s21} is a necessary evil, I understand, but..."),
("npc24_2ary_morality_speech","{s21} is a necessary evil, I understand, but..."),
...
("npc17_personalityclash_speech","I can't understand {s11}'s thought..."),
("npc18_personalityclash_speech","I can't understand {s11}'s thought..."),
("npc19_personalityclash_speech","I can't understand {s11}'s thought..."),
("npc20_personalityclash_speech","I can't understand {s11}'s thought..."),
("npc21_personalityclash_speech","I can't understand {s11}'s thought..."),
("npc22_personalityclash_speech","I can't understand {s11}'s thought..."),
("npc23_personalityclash_speech","I can't understand {s11}'s thought..."),
("npc24_personalityclash_speech","I can't understand {s11}'s thought..."),
...
("npc17_personalityclash_speech_b","I think the relation between {s11} and me will be bad."),
("npc18_personalityclash_speech_b","I think the relation between {s11} and me will be bad."),
("npc19_personalityclash_speech_b","I think the relation between {s11} and me will be bad."),
("npc20_personalityclash_speech_b","I think the relation between {s11} and me will be bad."),
("npc21_personalityclash_speech_b","I think the relation between {s11} and me will be bad."),
("npc22_personalityclash_speech_b","I think the relation between {s11} and me will be bad."),
("npc23_personalityclash_speech_b","I think the relation between {s11} and me will be bad."),
("npc24_personalityclash_speech_b","I think the relation between {s11} and me will be bad."),
...
### set off by behavior after victorious battle
 ...
 ("npc17_personalityclash2_speech","{s11} leers at me..."),
("npc18_personalityclash2_speech","{s11} leers at me..."),
("npc19_personalityclash2_speech","{s11} leers at me..."),
("npc20_personalityclash2_speech","{s11} leers at me..."),
("npc21_personalityclash2_speech","{s11} leers at me..."),
("npc22_personalityclash2_speech","{s11} leers at me..."),
("npc23_personalityclash2_speech","{s11} leers at me..."),
("npc24_personalityclash2_speech","{s11} leers at me..."),
...
("npc17_personalityclash2_speech_b","I want {s11} get away from me."),
("npc18_personalityclash2_speech_b","I want {s11} get away from me."),
("npc19_personalityclash2_speech_b","I want {s11} get away from me."),
("npc20_personalityclash2_speech_b","I want {s11} get away from me."),
("npc21_personalityclash2_speech_b","I want {s11} get away from me."),
("npc22_personalityclash2_speech_b","I want {s11} get away from me."),
("npc23_personalityclash2_speech_b","I want {s11} get away from me."),
("npc24_personalityclash2_speech_b","I want {s11} get away from me."),
...
("npc17_personalitymatch_speech","{s11} is a splendid person!"),
("npc18_personalitymatch_speech","{s11} is a splendid person!"),
("npc19_personalitymatch_speech","{s11} is a splendid person!"),
("npc20_personalitymatch_speech","{s11} is a splendid person!"),
("npc21_personalitymatch_speech","{s11} is a splendid person!"),
("npc22_personalitymatch_speech","{s11} is a splendid person!"),
("npc23_personalitymatch_speech","{s11} is a splendid person!"),
("npc24_personalitymatch_speech","{s11} is a splendid person!"),
...
("npc17_personalitymatch_speech_b","With {s11}, I feel my heart beats fast."),
("npc18_personalitymatch_speech_b","With {s11}, I feel my heart beats fast."),
("npc19_personalitymatch_speech_b","With {s11}, I feel my heart beats fast."),
("npc20_personalitymatch_speech_b","With {s11}, I feel my heart beats fast."),
("npc21_personalitymatch_speech_b","With {s11}, I feel my heart beats fast."),
("npc22_personalitymatch_speech_b","With {s11}, I feel my heart beats fast."),
("npc23_personalitymatch_speech_b","With {s11}, I feel my heart beats fast."),
("npc24_personalitymatch_speech_b","With {s11}, I feel my heart beats fast."),
...
("npc17_retirement_speech","I feel the direction of wind change..."),
("npc18_retirement_speech","I feel the direction of wind change..."),
("npc19_retirement_speech","I feel the direction of wind change..."),
("npc20_retirement_speech","I feel the direction of wind change..."),
("npc21_retirement_speech","I feel the direction of wind change..."),
("npc22_retirement_speech","I feel the direction of wind change..."),
("npc23_retirement_speech","I feel the direction of wind change..."),
("npc24_retirement_speech","I feel the direction of wind change..."),
 ...
 ("npc17_rehire_speech","I travell as before, but I miss you. Please let me join you."),
("npc18_rehire_speech","I travell as before, but I miss you. Please let me join you."),
("npc19_rehire_speech","I travell as before, but I miss you. Please let me join you."),
("npc20_rehire_speech","I travell as before, but I miss you. Please let me join you."),
("npc21_rehire_speech","I travell as before, but I miss you. Please let me join you."),
("npc22_rehire_speech","I travell as before, but I miss you. Please let me join you."),
("npc23_rehire_speech","I travell as before, but I miss you. Please let me join you."),
("npc24_rehire_speech","I travell as before, but I miss you. Please let me join you."),
...
#local color strings
 ...
 ("npc17_home_intro","My home is near here..."),
("npc18_home_intro","My home is near here..."),
("npc19_home_intro","My home is near here..."),
("npc20_home_intro","My home is near here..."),
("npc21_home_intro","My home is near here..."),
("npc22_home_intro","My home is near here..."),
("npc23_home_intro","My home is near here..."),
("npc24_home_intro","My home is near here..."),
...
("npc17_home_description","I miss everything..."),
("npc18_home_description","I miss everything..."),
("npc19_home_description","I miss everything..."),
("npc20_home_description","I miss everything..."),
("npc21_home_description","I miss everything..."),
("npc22_home_description","I miss everything..."),
("npc23_home_description","I miss everything..."),
("npc24_home_description","I miss everything..."),
...
("npc17_home_description_2","But I haven't been able to return, yet."),
("npc18_home_description_2","But I haven't been able to return, yet."),
("npc19_home_description_2","But I haven't been able to return, yet."),
("npc20_home_description_2","But I haven't been able to return, yet."),
("npc21_home_description_2","But I haven't been able to return, yet."),
("npc22_home_description_2","But I haven't been able to return, yet."),
("npc23_home_description_2","But I haven't been able to return, yet."),
("npc24_home_description_2","But I haven't been able to return, yet."),
...
("npc17_home_recap","Just an ordinary traveller."),
("npc18_home_recap","Just an ordinary traveller."),
("npc19_home_recap","Just an ordinary traveller."),
("npc20_home_recap","Just an ordinary traveller."),
("npc21_home_recap","Just an ordinary traveller."),
("npc22_home_recap","Just an ordinary traveller."),
("npc23_home_recap","Just an ordinary traveller."),
("npc24_home_recap","Just an ordinary traveller."),
...
("npc17_honorific","My master"),
("npc18_honorific","My master"),
("npc19_honorific","My master"),
("npc20_honorific","My master"),
("npc21_honorific","My master"),
("npc22_honorific","My master"),
("npc23_honorific","My master"),
("npc24_honorific","My master"),
...
("npc17_kingsupport_1","Yes, I know."),
("npc18_kingsupport_1","Yes, I know."),
("npc19_kingsupport_1","Yes, I know."),
("npc20_kingsupport_1","Yes, I know."),
("npc21_kingsupport_1","Yes, I know."),
("npc22_kingsupport_1","Yes, I know."),
("npc23_kingsupport_1","Yes, I know."),
("npc24_kingsupport_1","Yes, I know."),
...
("npc17_kingsupport_2","But, does such wind blow?"),
("npc18_kingsupport_2","But, does such wind blow?"),
("npc19_kingsupport_2","But, does such wind blow?"),
("npc20_kingsupport_2","But, does such wind blow?"),
("npc21_kingsupport_2","But, does such wind blow?"),
("npc22_kingsupport_2","But, does such wind blow?"),
("npc23_kingsupport_2","But, does such wind blow?"),
("npc24_kingsupport_2","But, does such wind blow?"),
...
("npc17_kingsupport_2a","Yes, I feel."),
("npc18_kingsupport_2a","Yes, I feel."),
("npc19_kingsupport_2a","Yes, I feel."),
("npc20_kingsupport_2a","Yes, I feel."),
("npc21_kingsupport_2a","Yes, I feel."),
("npc22_kingsupport_2a","Yes, I feel."),
("npc23_kingsupport_2a","Yes, I feel."),
("npc24_kingsupport_2a","Yes, I feel."),
...
("npc17_kingsupport_2b","Too early."),
("npc18_kingsupport_2b","Too early."),
("npc19_kingsupport_2b","Too early."),
("npc20_kingsupport_2b","Too early."),
("npc21_kingsupport_2b","Too early."),
("npc22_kingsupport_2b","Too early."),
("npc23_kingsupport_2b","Too early."),
("npc24_kingsupport_2b","Too early."),
...
("npc17_kingsupport_3","Well, May I spread your legitimacy?"),
("npc18_kingsupport_3","Well, May I spread your legitimacy?"),
("npc19_kingsupport_3","Well, May I spread your legitimacy?"),
("npc20_kingsupport_3","Well, May I spread your legitimacy?"),
("npc21_kingsupport_3","Well, May I spread your legitimacy?"),
("npc22_kingsupport_3","Well, May I spread your legitimacy?"),
("npc23_kingsupport_3","Well, May I spread your legitimacy?"),
("npc24_kingsupport_3","Well, May I spread your legitimacy?"),
...
("npc17_kingsupport_objection","I feel the bad wind..."),
("npc18_kingsupport_objection","I feel the bad wind..."),
("npc19_kingsupport_objection","I feel the bad wind..."),
("npc20_kingsupport_objection","I feel the bad wind..."),
("npc21_kingsupport_objection","I feel the bad wind..."),
("npc22_kingsupport_objection","I feel the bad wind..."),
("npc23_kingsupport_objection","I feel the bad wind..."),
("npc24_kingsupport_objection","I feel the bad wind..."),
...
("npc17_intel_mission","My acquaintance lives in {s17}. I will visit there."),
("npc18_intel_mission","My acquaintance lives in {s18}. I will visit there."),
("npc19_intel_mission","My acquaintance lives in {s19}. I will visit there."),
("npc20_intel_mission","My acquaintance lives in {s20}. I will visit there."),
("npc21_intel_mission","My acquaintance lives in {s21}. I will visit there."),
("npc22_intel_mission","My acquaintance lives in {s22}. I will visit there."),
("npc23_intel_mission","My acquaintance lives in {s23}. I will visit there."),
("npc24_intel_mission","My acquaintance lives in {s24}. I will visit there."),
...
("npc17_fief_acceptance","Certainly. I manage that fief, obey your order."),
("npc18_fief_acceptance","Certainly. I manage that fief, obey your order."),
("npc19_fief_acceptance","Certainly. I manage that fief, obey your order."),
("npc20_fief_acceptance","Certainly. I manage that fief, obey your order."),
("npc21_fief_acceptance","Certainly. I manage that fief, obey your order."),
("npc22_fief_acceptance","Certainly. I manage that fief, obey your order."),
("npc23_fief_acceptance","Certainly. I manage that fief, obey your order."),
("npc24_fief_acceptance","Certainly. I manage that fief, obey your order."),
  ...
  ("npc16_woman_to_woman", "Oy, Captain -- if you don't mind me saying, you've made quite a name for yourself in these parts. I suspect that if you were a man, a king would have offered you a fief by now. But we ladies should come to expect things like that. Men will find any excuse not to reward us for our work, so if we take a fancy to a bit of land somewhere, maybe we should just reach out and take it. That's the way I look at the world, anyway."), #klethi
      ...
      ("npc18_woman_to_woman", "Calradian wind feels so cold for women..."),#
      ("npc19_woman_to_woman", "{!}."),
      ("npc20_woman_to_woman", "Calradian wind feels so cold for women..."),#
      ("npc21_woman_to_woman", "{!}."),
      ("npc22_woman_to_woman", "{!}."),
      ("npc23_woman_to_woman", "{!}."),
      ("npc24_woman_to_woman", "Calradian wind feels so cold for women..."),#
  ...
  ("npc16_turn_against", "Hello, Captain! So, I guess we're enemies! One small word of warning if we end up fighting each other -- once the rage of battle hits me, I can't always account for my actions. Just know that whatever I do, it's not personal. Maybe if we both walk away from this, we can meet once more as friends?"), #klethi
    ("npc17_turn_against","Do you feel Calradian wind, yet?"),
    ("npc18_turn_against","Do you feel Calradian wind, yet?"),
    ("npc19_turn_against","Do you feel Calradian wind, yet?"),
    ("npc20_turn_against","Do you feel Calradian wind, yet?"),
    ("npc21_turn_against","Do you feel Calradian wind, yet?"),
    ("npc22_turn_against","Do you feel Calradian wind, yet?"),
    ("npc23_turn_against","Do you feel Calradian wind, yet?"),
    ("npc24_turn_against","Do you feel Calradian wind, yet?"),
...
#steve post 0912 changes begin
  ...
  #CC-C faction dk pretender text
  ("dark_knight_rebellion_pretender_intro", "I am Eowyn, whom they call the White princess of Rohan."),
 ...
 ("sarranid_rebellion_pretender_story_1", "I was born in a faraway land, to a humble family, and made a slave when I was but a girl -- but there is no shame in that, for the mothers of many of our kings were slaves. The old Sultan, Ayzar, spotted me in the markets and was struck by my beauty. I entered his household, and there he also learned to respect my intelligence. As he grew older, he allowed me to govern in his stead. First I managed the affairs of the palace, and later those of the realm."),
  #CC-C faction dk pretender text
  ("dark_knight_rebellion_pretender_story_1", "I love war."),
 ...
 ("sarranid_rebellion_pretender_story_2", "When Sultan Ayzar died, it seemed to the emirs of the realm only natural that I should succeed him as ruler, thus avoiding any danger of civil war. They insisted, however, that I should marry one of his generals, the Emir Baybak. The emirs then lined up to give us the oath of allegiance together -- to Baybak as Commander of the Armies, and to me as Mother of the Realm. For the brief time that we ruled, our realm prospered."),
  #CC-C faction dk pretender text
  ("dark_knight_rebellion_pretender_story_2", "I love death."),
  ...
  #CC-C faction dk pretender text
  ("dark_knight_rebellion_pretender_story_3", "I came to stain Calradia to blood."),
  ...
  #CC-C faction dk pretender text
  ("dark_knight_rebellion_monarch_response_1", "He is witch."),
  ...
  #CC-C faction dk pretender text
  ("dark_knight_rebellion_monarch_response_2", "Do not relevant to her.Calradia goes down."),
...
#courtship
  ...
  ("psf_adjective",                           "Player Faction"), ## NMC
...
#CC-C begin faction dk
  ("kingdom_7_adjective","Dark Knight"),
#CC-C end
#occc start
  ("kingdom_8_adjective",                     "Hellas"),
  ("kingdom_9_adjective",                     "Hinomoto"),
  ("kingdom_10_adjective",                     "Sunset"),
  ("kingdom_11_adjective",                     "Zendar=Rhodok"),
  ("kingdom_12_adjective",                     "Murom=Vaegir"),
  ("kingdom_13_adjective",                     "Ring"),
  ("kingdom_14_adjective",                     "Balion"),
...
##diplomacy end+
  ...
  ("rhodoks", "Rhodoks"),
  ("sarranids", "Sarranids"),
  ("darkknight", "Dark Knight"), #CC-C add faction
  ("hellas", "Hellas"), #occc
  ("taikou", "Taikou Conquest Army"), #occc
  ("quetzal", "Quetzal"), #occc
  ("oldrhodok", "Zendar=Rhodok"), #occc
  ("oldvaegir", "Murom=Vaegir"), #occc
  ("ring", "Ring"), #occc
  ("albion", "Balion"), #occc
  ("bandits", "bandits"),
  ("deserters", "deserters"),
...
#  ("s15", "{!}{s15"),
  #("s15", "{!}{s15}"),  ## NMCml NativeFix: duplicated and {s15->{s15}
##diplomacy end+
...
##diplomacy end+ (making both-gender version)
  ...
  ("s12_close", "{!}{s12}."),  ## NMCml NativeFix: s12->s12_close
...
#STRINGS ADDED AFTER THE FREEZE
  ...
  ("faction_king_title_2", "Empereur {s0}"),
  ("faction_king_title_3", "{s0} Khan"),
  ("faction_king_title_4", "Konungr {s0}"),
  ("faction_king_title_5", "Imperator {s0}"),#occc
  ("faction_king_title_6", "Sultan {s0}"),
#CC-D begin
  ("faction_king_title_7", "Dark Lord {s0}"),
#CC-D end
#occc start
  ("faction_king_title_8", "{s0} The Great"),
  ("faction_king_title_9", "{s0} Taikou"),
  ("faction_king_title_10", "Huetlatoani {s0}"),
  ("faction_king_title_11", "Doge {s0}"),
  ("faction_king_title_12", "Grand Prince {s0}"),
  ("faction_king_title_13", "King {s0}"),#Ring
  ("faction_king_title_14", "Bretwalda {s0}"),#Albion
...
#occc end
  ...
  ("faction_title_male_2", "Commander {s0}"),#occc
  ("faction_title_male_3", "{s0} Noyan"),
  ("faction_title_male_4", "Jarl {s0}"),
  ("faction_title_male_5", "Legatus {s0}"),
  ("faction_title_male_6", "Emir {s0}"),
#CC-C begin faction dk
  ("faction_title_male_7", "Darth {s0}"),
#CC-C end faction dk
#occc start
  ("faction_title_male_8", "Strategos {s0}"),
  ("faction_title_male_9", "Daimyo {s0}"),
  ("faction_title_male_10", "Warlord {s0}"),
  ("faction_title_male_11", "Count {s0}"),
  ("faction_title_male_12", "Boyar {s0}"),
  ("faction_title_male_13", "Lord {s0}"),
  ("faction_title_male_14", "Earl {s0}"),

#occc end
  ("faction_title_female_player", "Lady {s0}"),
  ("faction_title_female_1", "Countess {s0}"),
  ("faction_title_female_2", "Commander {s0}"),
  ("faction_title_female_3", "{s0} Hatun"),
  ("faction_title_female_4", "Grevinne {s0}"),
  ("faction_title_female_5", "Legatus {s0}"),
  ("faction_title_female_6", "Sayeda {s0}"),
#CC-C begin faction dk
  ("faction_title_female_7", "Darth {s0}"),
#CC-C end faction dk

#occc start
  ("faction_title_female_8", "Queen {s0}"),
  ("faction_title_female_9", "Daimyo {s0}"),
  ("faction_title_female_10", "Warlord {s0}"),
  ("faction_title_female_11", "Countess {s0}"),
  ("faction_title_female_12", "Boyarina {s0}"),
  ("faction_title_female_13", "Lady {s0}"),
  ("faction_title_female_14", "Countess {s0}"),
...
##diplomacy end+
  ...
  #("quick_battle_troop_12", "Sigfrid of Xanten is the well-known Nibelungen hero. One day, the young prince met Schilbung and Nibelung, two powerful and rich kings who wanted to divide their wealth equally, but didn't trust each other. Therefore, they offered Sigfrid the sharp sword Balmung in return for dividing the huge pile of treasures fairly between the two kings. After having done so, he received the sword, but the two kings thought the other one had received more and in the end, they attacked Sigfrid. However, with the famous sword in his hand, he slew the 2 greedy and ungrateful kings and many of their followers, including Alberich, a dwarfen king wearing magical artifacts. He and the remaining men acknowledged him as new king of the Nibelungen. His next target was a dragon who terrorized the country. Sigfrid killed the dragon, drinked from and bathed in the creature's blood that now grants him the power of twelve men and a nearly invincible skin. From that moment on, he turned into a legend and many fear crossing blades with him."),  ## CC-D: not use
  #("quick_battle_troop_13", "Gastra was just a little boy when his village was burned to the ground by a group of merciless dark hunters. Lucky to have escaped, Gastra sweared revenge and he and the other survivors sought refuge in a nearby Rhodok castle. There, they were treated well and when Gastra was old enough, he joined the count's army and over the years, he became an excellent crossbowmen. Still, the desire to revenge his people burned deep inside him and one day, he asked for permission to leave the count's service to hunt the dark knights. The count, having suffered from that black plague as well, granted him the permission and Gastra marched through the land in search for the dark hunters and brave men to accompany him. Many joined him and one day, he and his crossbowmen ambushed the dark hunters while they were trying to massacre yet another innocent village. Surprised by the sharp bolts, the dark hunters ran away. Now Gastra and his loyal crossbowmen can be found traveling through Calradia in search of the last dark hunters to finish them off once and for all."),  ## CC-D: not use
  #("quick_battle_troop_14", "Orio Arimondi used to work as captain of the heavy infantry for the Doge of Tirimaldo, a wealthy trading republic far to the west of Calradia. One day, he and his heavy infantry were sent via ship to a remote outpost which was troubled by raiders. Unfortunately, a heavy storm appeared out of nowhere and the ship was blown away from their original destination and washed ashore at Calradia. The crew was unable to repair the severly damaged ship, so Orio and his men left the beach to look for help. While they were away, sea raiders appeared, killed the crew, robbed everything of value and disappeared. Orio and his men were shocked when they returned to the beach and saw no way to get back home. Therefore, Orio founded a mercenary company and he and his tough men are now trying to raise money for their return to Tirimaldo."),  ## CC-D: not use
#Player Faction
...
## CC-D begin
  ("faction_king_female_title_7", "Dark Lord {s0}"),
## CC-D end
...
## CC
 ...
 ("dplmc_neither_mercantilist_nor_laissez_faire","neither particularly mercantilist^ nor entirely laissez-faire"),  ## CC-D add ^
...
#CC-C begin
## CC-D begin: sort and fix
  ("ccc_reputation_martial", "martial person."),
  ("ccc_reputation_quarrelsome", "quarrelsome person."),
  ("ccc_reputation_pitiless", "pitiless person."),
  ("ccc_reputation_calculating", "calculating person."),
  ("ccc_reputation_debauched", "debauched person."),
  ("ccc_reputation_goodnatured", "good-natured person."),
  ("ccc_reputation_upstanding", "upstanding person."),
  ("ccc_reputation_roguish", "roguish person."),
  ("ccc_reputation_benefactor", "benefactor person."),
  ("ccc_reputation_custodian", "custodian person."),
  ("ccc_reputation_conventional", "conventional person."),
  ("ccc_reputation_adventurous", "adventurous person."),
  ("ccc_reputation_romantic", "romantic person."),
  ("ccc_reputation_ambitious", "ambitious person."),
  ("ccc_reputation_moralist", "moralist."),
  ("ccc_reputation_unknown", "It's nothing known."),
## CC-D end
  ("ccc_rhodoks_mine_info","Good mine. I want to mine.^Discuss with the owner in the mine or with the sword"),
  ("ccc_wedding_hall_info","What is happiness?"),
  ("ccc_fertility_festival_info","I love festival. "),
  ("ccc_add_mineworker_info","Add Mineworker:{reg0}^Good Mineworker:{reg1}"),
  ("ccc_add_mineworker_overd_limit","Sorry Overd limit."),
  ("ccc_add_mineworker_no_prisoner","Sorry You are not taking the prisoner."),
  ("ccc_mineworker_info","Mineworker:{reg0}^Good Mineworker:{reg1}^Slacker Mineworker:{reg2}^Total:{reg3}^Limit:{reg4}"),
  ("ccc_wedding_isolla_stage3","Good Wedding"),
  ("ccc_wedding_isolla_stage4","Good Morning"),
  ("ccc_add_ero_power","{s0} change Ero Power from {reg0} to {reg1}"),
  ("ccc_chenge_submit","{s0} change Submit from {reg0} to {reg1}"),
  ("ccc_ero_cherry","Cherry Boy"),
  ("ccc_ero_30_cherry","Wizard"),
  ("ccc_ero_40_cherry","Hermit"),
  ("ccc_ero_virgin","Virgin"),
  ("ccc_ero_30_virgin","Iron Maiden"),
  ("ccc_ero_0","Cool"),
  ("ccc_ero_10","Water flea Eros"),
  ("ccc_ero_20","Ant Eros"),
  ("ccc_ero_30","Dog Eros"),
  ("ccc_ero_40","Slave Eros"),
  ("ccc_ero_50","Villager Eros"),
  ("ccc_ero_60","Citizen Eros"),
  ("ccc_ero_70","Servant Eros"),
  ("ccc_ero_80","knight Eros"),
  ("ccc_ero_90","Load Eros"),
  ("ccc_ero_100","King Eros"),
  ("ccc_ero_101","Legend of Eros"),
  ("ccc_ero_200","God Eros"),
  ("ccc_dammy_message","......"),
  ("ccc_help_message_lead","*** Cave Expansion Key ***^(Only Cave AI ON) Num5:Free Weapon  Num6:Sword  Num7:Polearm  Num8:Range Num9:Two Handed^LCtrl+Y:Auto My Army  U:Stand and Fight  LCtrl+U:Move Free  K:Cry Victory(with around by +LCtrl)^M:Horse Whistle  B:Spear Blace  G:Set Pavise  LCtrl+T:Camera Mode^Ctrl+m:Form Rank  Ctrl+,:Form Shield Wall  Ctrl+.:Form Wedge  Ctrl+/:Form Square  Ctrl+;:Remove Formation "),
  ("ccc_help_message_heven","*** Heaven ***^N:Next Skill  M:Previous Skill  B:Stop^H:Change atk or def  K:Boost On/Off  X:Shoot^J:Option A  ,:Option B  .:Option C  tab:Easy Sex  LCtrl+T:Camera Mode"),
  ("ccc_help_message_cave","*** Cave ***^tab:Info  LCtrl+B:Give Up  H:Heal"),
  ("ccc_help_message_duel","*** Duel ***^tab:Give Up"),
  ("ccc_gob_report","Name:{s11}^Faction:{s12}^Age:{reg13}^Reputation:{s14}^Relation:{reg15}^Submit:{reg16}^Ero:{s17}^Love day:{s18}^Duel day:{s19}^Prisoner days:{reg20}^Spouse:{s21}^HP:{reg22}^{s23}"),
  ("ccc_slave_price_a","Very Good Prostitute"),
  ("ccc_slave_price_b","Good Prostitute"),
  ("ccc_slave_price_c","Prostitute"),
  ("ccc_slave_price_d","Slave"),
  ("ccc_slave_price_e","No price slave"),
  ("ccc_add_princess","Princess {s1}"),
  ("ccc_add_lady","Lady {s1}"),
  ("ccc_add_marshall","Marshall {s0}"),
  ("ccc_retirement_text_dead","You died on the way"),
#heven message *****************************************************************
  ("ccc_heven_before_female_wife_eros_start","Good Comin..."),
  ("ccc_heven_before_female_wife_eros_end","Yes..."),
  ("ccc_heven_before_female_eros_start","No... But I actually..."),
  ("ccc_heven_before_female_eros_1","Be good to me..."),
  ("ccc_heven_before_female_eros_2","Finally..."),
  ("ccc_heven_before_female_eros_end","Lon't..."),
  ("ccc_heven_before_female_aggressive_start","Vermin!"),
  ("ccc_heven_before_female_aggressive_1","Beast!"),
  ("ccc_heven_before_female_aggressive_2","Vulgar man!"),
  ("ccc_heven_before_female_aggressive_3","Suit yourself."),
  ("ccc_heven_before_female_aggressive_end","Abnormal man! Pervert! Sex animal!"),
  ("ccc_heven_before_female_normal_start","I can't believe that actually happened..."),
  ("ccc_heven_before_female_normal_1","I must be a plaything..."),
  ("ccc_heven_before_female_normal_2","I wanna go home..."),
  ("ccc_heven_before_female_normal_end","Is this the test?"),
  ("ccc_heven_before_female_aggressive_virgin_start","To do with dog is better than with you!"),
  ("ccc_heven_before_female_aggressive_virgin_end","Be cursed!"),
  ("ccc_heven_before_female_normal_virgin_start","Where will you take me to?"),
  ("ccc_heven_before_female_normal_virgin_end","......"),
  ("ccc_heven_before_male_eros_1","Uho, good man."),
#*******************************************************************************
#Random NPC ********************************************************************
#Traveler base
  ("ccc_random_npc_normal_intro","Nice to meet you. I'm a traveller."),
  ("ccc_random_npc_normal_intro_response_1","Do you feel the wind is blowing on Calradia?"),
  ("ccc_random_npc_normal_intro_response_2","Sorry, I have a mistake. Bye."),
  ("ccc_random_npc_normal_backstory_a","You are interesting."),
  ("ccc_random_npc_normal_backstory_b","I have travelled with Calradian wind leading."),
  ("ccc_random_npc_normal_backstory_c","And Calradian wind may lead us here..."),
  ("ccc_random_npc_normal_backstory_later","I'm traveller as before."),
  ("ccc_random_npc_normal_backstory_response_1","Calradian wind blows with me. Come and join us."),
  ("ccc_random_npc_normal_backstory_response_2","Sorry, I'm just saying. Bye."),
  ("ccc_random_npc_normal_signup","Okay."),
  ("ccc_random_npc_normal_signup_2","My skills must be useful for you."),
  ("ccc_random_npc_normal_signup_response_1","Let's go."),
  ("ccc_random_npc_normal_signup_response_2","My mind changed. Bye."),
  ("ccc_random_npc_normal_payment","I need {reg3} denar for the deposit. Ok?"),
  ("ccc_random_npc_normal_payment_response","Here you are."),
  ("ccc_random_npc_normal_morality_speech","I don't become to like {s21}..."),
  ("ccc_random_npc_normal_2ary_morality_speech","{s21} is a necessary evil, I understand, but..."),
  ("ccc_random_npc_normal_personalityclash_speech","I can't understand {s11}'s thought..."),
  ("ccc_random_npc_normal_personalityclash_speech_b","I think the relation between {s11} and me will be bad."),
  ("ccc_random_npc_normal_personalityclash2_speech","{s11} leers at me..."),
  ("ccc_random_npc_normal_personalityclash2_speech_b","I want {s11} get away from me."),
  ("ccc_random_npc_normal_personalitymatch_speech","{s11} is a splendid person!"),
  ("ccc_random_npc_normal_personalitymatch_speech_b","With {s11}, I feel my heart beats fast."),
  ("ccc_random_npc_normal_retirement_speech","I feel the direction of wind change..."),
  ("ccc_random_npc_normal_rehire_speech","I travell as before, but I miss you. Please let me join you."),
  ("ccc_random_npc_normal_home_intro","My home is near here..."),
  ("ccc_random_npc_normal_home_description","I miss everything..."),
  ("ccc_random_npc_normal_home_description_2","But I haven't been able to return, yet."),
  ("ccc_random_npc_normal_home_recap","Just an ordinary traveller."),
  ("ccc_random_npc_normal_honorific","My master"),
  ("ccc_random_npc_normal_kingsupport_1","Yes, I know."),
  ("ccc_random_npc_normal_kingsupport_2","But, does such wind blow?"),
  ("ccc_random_npc_normal_kingsupport_2a","Yes, I feel."),
  ("ccc_random_npc_normal_kingsupport_2b","Too early."),
  ("ccc_random_npc_normal_kingsupport_3","Well, May I spread your legitimacy?"),
  ("ccc_random_npc_normal_kingsupport_objection","I feel the bad wind..."),
  ("ccc_random_npc_normal_intel_mission","My acquaintance lives in {s17}. I will visit there."),
  ("ccc_random_npc_normal_fief_acceptance","Certainly. I manage that fief, obey your order."),
  ("ccc_random_npc_normal_woman_to_woman","Calradian wind feels so cold for women..."),
  ("ccc_random_npc_normal_turn_against","Do you feel Calradian wind, yet?"),
#child
  ("ccc_random_npc_child_normal_intro","Are you my {father/mother}?"),
  ("ccc_random_npc_child_normal_intro_response_1","Oh, Yes!"),
  ("ccc_random_npc_child_normal_intro_response_2","You have mistake, bye."),
  ("ccc_random_npc_child_normal_backstory_a","I have found out you finally."),
  ("ccc_random_npc_child_normal_backstory_b","My power has been trained enough through experience on the Calradia."),
  ("ccc_random_npc_child_normal_backstory_c","And Calradian wind must lead our encount."),
  ("ccc_random_npc_child_normal_backstory_later","I'm travelling with Calradian wind. Some times I return our hide house to meet Fubuki."),
  ("ccc_random_npc_child_normal_backstory_response_1","Well, do you want ton join us?"),
  ("ccc_random_npc_child_normal_backstory_response_2","Ok, take care."),
  ("ccc_random_npc_child_normal_signup","Yes please."),
  ("ccc_random_npc_child_normal_signup_2","I must be available for you."),
  ("ccc_random_npc_child_normal_signup_response_1","Ok, come in."),
  ("ccc_random_npc_child_normal_signup_response_2","No, you are premature yet."),
  ("ccc_random_npc_child_normal_payment","I'm glad to that. Ah, I need {reg3} denar for the deposit. Ok?"),
  ("ccc_random_npc_child_normal_payment_response","Yes, here {reg3} denar."),
  ("ccc_random_npc_child_normal_morality_speech","My {father/mother}, I need your explain about {s21}."),
  ("ccc_random_npc_child_normal_2ary_morality_speech","My {father/mother}, {s21} is a necessary evil, I understand, but..."),
  ("ccc_random_npc_child_normal_personalityclash_speech","My {father/mother}, about {s11}..."),
  ("ccc_random_npc_child_normal_personalityclash_speech_b","{s11} spread a bad rumor about me."),
  ("ccc_random_npc_child_normal_personalityclash2_speech","My {father/mother}, about {s11}..."),
  ("ccc_random_npc_child_normal_personalityclash2_speech_b","{s11} leers at me..."),
  ("ccc_random_npc_child_normal_personalitymatch_speech","My {father/mother}, {s11} is very good person!"),
  ("ccc_random_npc_child_normal_personalitymatch_speech_b","With {s11}, I feel safe for the first time in my life, without Fubuki."),
  ("ccc_random_npc_child_normal_retirement_speech","My {father/mother}, Calradian wind calls me. Please let me go."),
  ("ccc_random_npc_child_normal_rehire_speech","Calradian wind must lead us again. Please let me join you."),
  ("ccc_random_npc_child_normal_home_intro","I've stayed here before."),
  ("ccc_random_npc_child_normal_home_description","Fubuki take care for me often."),
  ("ccc_random_npc_child_normal_home_description_2","I feel her as my elder sister."),
  ("ccc_random_npc_child_normal_home_recap","I'm from our hide house."),
  ("ccc_random_npc_child_normal_honorific","{father/mother}"),
  ("ccc_random_npc_child_normal_kingsupport_1","Yes, my {father/mother}, I believe you will be the {king/queen}, and new wind in Calradia."),
  ("ccc_random_npc_child_normal_kingsupport_2","Yes, of course. What do you wish me?"),
  ("ccc_random_npc_child_normal_kingsupport_2a","You spread my legitimacy."),
  ("ccc_random_npc_child_normal_kingsupport_2b","Well, some other time."),
  ("ccc_random_npc_child_normal_kingsupport_3","Certainly. Fubuki may help me."),
  ("ccc_random_npc_child_normal_kingsupport_objection","I feel the bad wind..."),
  ("ccc_random_npc_child_normal_intel_mission","Fubuki's colleague sent to {s17}, is working at {s18}. I will meet her."),
  ("ccc_random_npc_child_normal_fief_acceptance","Certainly. I manage that fief, obey your order."),
  ("ccc_random_npc_child_normal_woman_to_woman","My mother, your achievements are great, but your reputationis not enough. Calradian wind feels cold for women like us."),
  ("ccc_random_npc_child_normal_turn_against","We are the family, but now the enemy. I do my best, My {father/mother}!"),
#bandit
## CC-D begin: delete because cave09 does not set bandit NPC message
#  ("ccc_random_npc_bandit_normal_intro","......1"),
#  ("ccc_random_npc_bandit_normal_intro_response_1","......2"),
#  ("ccc_random_npc_bandit_normal_intro_response_2","......3"),
#  ("ccc_random_npc_bandit_normal_backstory_a","......4"),
#  ("ccc_random_npc_bandit_normal_backstory_b","......5"),
#  ("ccc_random_npc_bandit_normal_backstory_c","......6"),
#  ("ccc_random_npc_bandit_normal_backstory_later","......7"),
#  ("ccc_random_npc_bandit_normal_backstory_response_1","......8"),
#  ("ccc_random_npc_bandit_normal_backstory_response_2","......9"),
#  ("ccc_random_npc_bandit_normal_signup","......10"),
#  ("ccc_random_npc_bandit_normal_signup_2","......11"),
#  ("ccc_random_npc_bandit_normal_signup_response_1","......12"),
#  ("ccc_random_npc_bandit_normal_signup_response_2","......13"),
#  ("ccc_random_npc_bandit_normal_payment","......14"),
#  ("ccc_random_npc_bandit_normal_payment_response","......15"),
#  ("ccc_random_npc_bandit_normal_morality_speech","......16"),
#  ("ccc_random_npc_bandit_normal_2ary_morality_speech","......17"),
#  ("ccc_random_npc_bandit_normal_personalityclash_speech","......18"),
#  ("ccc_random_npc_bandit_normal_personalityclash_speech_b","......19"),
#  ("ccc_random_npc_bandit_normal_personalityclash2_speech","......20"),
#  ("ccc_random_npc_bandit_normal_personalityclash2_speech_b","......21"),
#  ("ccc_random_npc_bandit_normal_personalitymatch_speech","......22"),
#  ("ccc_random_npc_bandit_normal_personalitymatch_speech_b","......23"),
#  ("ccc_random_npc_bandit_normal_retirement_speech","......24"),
#  ("ccc_random_npc_bandit_normal_rehire_speech","......25"),
#  ("ccc_random_npc_bandit_normal_home_intro","......26"),
#  ("ccc_random_npc_bandit_normal_home_description","......27"),
#  ("ccc_random_npc_bandit_normal_home_description_2","......28"),
#  ("ccc_random_npc_bandit_normal_home_recap","......29"),
#  ("ccc_random_npc_bandit_normal_honorific","......30"),
#  ("ccc_random_npc_bandit_normal_kingsupport_1","......31"),
#  ("ccc_random_npc_bandit_normal_kingsupport_2","......32"),
#  ("ccc_random_npc_bandit_normal_kingsupport_2a","......33"),
#  ("ccc_random_npc_bandit_normal_kingsupport_2b","......34"),
#  ("ccc_random_npc_bandit_normal_kingsupport_3","......35"),
#  ("ccc_random_npc_bandit_normal_kingsupport_objection","......36"),
#  ("ccc_random_npc_bandit_normal_intel_mission","......37"),
#  ("ccc_random_npc_bandit_normal_fief_acceptance","......38"),
#  ("ccc_random_npc_bandit_normal_woman_to_woman","......39"),
#  ("ccc_random_npc_bandit_normal_turn_against","......40"),
## CC-D end
#*******************************************************************************
  ("ccc_military_power_text","Alive Ally:{reg1}/{reg3} Enemy:{reg2}/{reg4}"),
#CC-C end

## CC-D begin
  ("reputation_type_conventional", "conventional"),
  ("reputation_type_adventurous",  "adventurous"),
  ("reputation_type_otherworldly", "romantic"),
  ("reputation_type_ambitious",    "ambitious"),
  ("reputation_type_moralist",     "moralist"),

  ("ccd_quick_battle_troop_1", "Kern is an eccentric blacksmith."),
  ("ccd_quick_battle_troop_player", "Nobody knows who it is."),

  ("ccd_enter_lair", "You get close your secret lair.^^Your lair allows you to recruit some bandits,^And if you leave your troops here, they will become bandits."),
  ("ccd_khergit_zombie_1_info", "At the night, you hear what you haven't heard yet..."),
  ("ccd_khergit_zombie_2_info", "You find yourself to get alone, to have no weapon.^ You can only run away!"),
  ("ccd_khergit_zombie_3_info", "No one knows wheter it is real or nightmare, the house you reached exists..."),
  ("ccd_sarranid_samurai_hall_info", "Beyond silk road, samurais are coming. ^^Today, they hold a session with a noble guest..."),
  ("ccd_north_valkyrie_realm_info", "Dark Knights seem to be searching something around here. ^But as it happen, you find out it."),

  ("ccd_help_message_dc_diplomacy","*** CDS Camera ***^WASD/Arrow:Move  Num2468:Rotate^e/Num+:Up  x/Num-:Down^Space/Num5:Accel  LShift:Horizontal  LCtrl+Lshift:Ground"),
  ("ccd_help_message_dc_smooth","*** Smooth Death Camera ***^WASD:Move  Mouse:Rotate^LShift:Up LCtrl:Down^Space:Accel"),
  ("ccd_help_message_dc_pbod","*** PBOD Death Camera ***^End:Mode^WASD:Move  Arrow:Rotate  Num+/Num-:Up/Down^LRClick:follow next/previous troop when death camera"),

  ("ccd_retirement_text_conquered", "The Calradia is conquered! It surprised whole world.^ As soon as the army of other country intruded to test,^ you quicly cleared like blowing wind.^ Now the world keeps watching your next action."),
  ("ccd_retirement_text_high_wealth", "Your wealth has reached to the abnormaly level. The cash you have already 90 percent of all in the Calradia.^ The power from your money will allow you to do everything you want. You have not finished the conquest yet, but you have already grasped the wolrd."),
## CC-D end
...
#occc start
  ...
  ("occc_reli_nofaith", "No religion"),
  ("occc_reli_saint_cross", "Christianity"),
  ("occc_reli_norse", "Norse"),
  ("occc_reli_lord_of_the_sky", "Tengri"),
  ("occc_reli_crescent_moon", "Islam"),
  ("occc_reli_olympians", "Roman-Greece"),
  ("occc_reli_kami_no_michi", "Shinto"),
  ("occc_reli_feathered_snake", "Quetzalcoatl"),
  ("occc_reli_oldgods_of_fertility", "Baal"),

  ("occc_calradic_empire_reclaim_faction_1",                     "Heiliges Calradisches Reich"),
  ("occc_calradic_empire_reclaim_faction_2",                     "Empire Vaegirs"),
  ("occc_calradic_empire_reclaim_faction_3",                     "Khergit-Calradic Empire"),
  ("occc_calradic_empire_reclaim_faction_4",                     "Nord-Calradic Empire"),
  ("occc_calradic_empire_reclaim_faction_5",                     "Nova Imperium Calradium"),
  ("occc_calradic_empire_reclaim_faction_6",                     "Sarranid Caliphate"),

  ("faction_kaiser_title", "Kaiser {s0}"),
  ("faction_emperor_title", "Augustus {s0}"),
  ("faction_caliph_title", "Caliph {s0}"),

  ("occc_rev_faction_vae",                     "Kingdom of Vaegirs"),

#TEMPERED  ADDED STRINGS BEGIN
...
#TEMPERED STRINGS END
  ("occc_perk_colossus","Colossus[10% additional HP]"),
  ("occc_perk_striker","Crippling Strike[8% additional melee damage]"),
  ("occc_perk_bullseye","Bullseye[8% additional ranged accuracy]"),
  ("occc_perk_strider","Strider[8% additional move speed]"),
  ("occc_perk_fastreload","Fast Reload[8% additional reload reduction]"),
  ("occc_perk_sniper","Sharpshooter[8% additional ranged damage]"),
  ("occc_perk_frenzy","Frenzy[8% additional attack speed]"),
  ("occc_perk_backstab","Backstab[Doubled back attack bonus damage]"),
  ("occc_perk_double_grip","Double Grip[Gain 12% melee bonus without shield]"),
  ("occc_perk_berserk","Berserk[Gain Lifesteal below 20kgs equip weight]"),
  ("occc_perk_ninelives","Nine Lives[Once per battle, receiving critical blow, survive with 1HP]"),
  ("occc_perk_laststand","Last Stand[When in a pinch, gain attack bonus]"),
  ("occc_perk_swordmaster","Swordmaster[Can parry arrows with 2handed wp on foot (At least 270 proficiency needed)]"),
  ("occc_perk_hoplite","Hoplite[Gain more greater one-handed polearm bonus]"),
  ("occc_perk_fightclub","Fight Club[HARD PUNCHING!]"),
  ("occc_perk_learning","Learning[Accelerating level up speed]"),
  ("occc_perk_piety","Piety[More likely to get religious relation bonus]"),
  ("occc_perk_cheering","Cheering[Rallying gets Heal effect]"),
  ("occc_perk_powerbash","Power Bash[Shield Bash Power-up]"),
  ("occc_perk_raise_dead","Raise Dead[Costing honor, you can summon Zombies (Ctrl+K)]"),

  
#  ("occc_traveler_talk_cancel","Uh, I'm sorry.^ I have no interesting stories to tell for now."),

#  ("occc_traveler_talk_1","I heard that Dark Knight troops are really well disciplined.^Some say that, their archers can shoot arrows precisely even in night darkness."),
  ("occc_traveler_talk_2","I think that troops of Nords are no doubt the strongest warriors in Calradia...^I wonder why only a few of them ride horse?"),
  ("occc_traveler_talk_3","Have you ever been in Albion, ah, well, the western island?^That is the worst place in Calradia."),
  ("occc_traveler_talk_4","A stranger once told me that, he saw some strange figures riding on something very scaly in the western island.^Really STRANGE story."),
  ("occc_traveler_talk_5","Have you met a very shady guy, called Suruga?^He once told me that he came from far far east, but I doubt it."),
  ("occc_traveler_talk_6","I heard that Sarranian people stride fast, even in a vast desert!"),
  ("occc_traveler_talk_7","Khergit Cavalry Archers are unbelievable skillful!!^I never want to turn against them."),
  ("occc_traveler_talk_8","You shouldn't turn against Swadian Knights!^Those knights have decent chivalry skill and besides the greatest armor in Calradia.^They're like mobile steel wall, indeed."),
  ("occc_traveler_talk_9","I heard that there is a guild called 'Calradic Maid Association'.^If only I could contact them!"),
  ("occc_traveler_talk_10","Have you ever hired siege weapon engineers?^Without them, you cannnot deal with artilleries!"),
  ("occc_traveler_talk_11","A passing merchant told me that, he saw something strange in a cave where he tried to take a rest.^Do you have any idea about it?"),
  ("occc_traveler_talk_12","Do you know Rhodok mine?^I heard that the mine produces a lot of irons and some interesting artifacts."),
  ("occc_traveler_talk_13","Have you made a deal with Foreign Merchant?^Their goods are weird, still, interesting."),
  ("occc_traveler_talk_14","Beware of spartan."),

  ("occc_traveler_talk_end","{!}"),
  #main faction kings rumor
  ("occc_traveler_talk_ppl_swadking","Rumor has it that, Great Swadian Lord, King Harlaus, has a stomachache."),
  ("occc_traveler_talk_ppl_vaegking","Some say that, Empereur Yaroglek is not REAL Yaroglek　himself.^But hey, who cares?^That Yaroglek is much better, isn't he?"),
  ("occc_traveler_talk_ppl_kherhero","Rumor has it that, one of Bo'orchu Noyan's relatives is a horsenapper."),
  ("occc_traveler_talk_ppl_nordking","Rumor has it that, Konungr Ragnar takes his most longest-serving housemen as Huskarls."),
  ("occc_traveler_talk_ppl_rhodking","Rumor has it that, Imperator Graveth has his personal bodyguards."),
  ("occc_traveler_talk_ppl_sarrking","Rumor has it that, Sultan Hakim trains saint-cross believers as his bodyguards."),
  ("occc_traveler_talk_ppl_darkking","Rumor has it that, Dark Lord Sauron summoned some otherworldly evil abominations."),
  
  #additional caves
  ("occc_silly_place_info","Seeking the holy grail, you have arrived a castle..."),
