...
pbod_last_troop     = "trp_relative_of_merchants_end" #Last Troop in Troops File  Floris: "trp_troops_end"; native: "trp_relative_of_merchants_end" 
...
## CC-D begin
slot_troop_orig_wpt_firearm      = 339  ## CC-D add, under +1...
slot_troop_pnty_wpt_archery      = 340 ##heroes only
slot_troop_pnty_wpt_crossbow     = 341 ##heroes only
slot_troop_pnty_wpt_throwing     = 342 ##heroes only
slot_troop_pnty_wpt_firearm      = 343 ##heroes only
## CC-D end
#Agent Slots
slot_agent_lance         = 81  ## CC-D begin: 33->81...
slot_agent_horsebow      = 82
slot_agent_spear         = 83
#slot_agent_horse         = 84  ## CC-D move
slot_agent_volley_fire   = 85
slot_agent_spearwall     = 86
slot_agent_player_braced = 87
slot_agent_alt_div_check = 88  ## CC-D end
#slot_agent_new_division  = 41
#Team Slots (so high to allow for formations)
slot_team_d0_order_weapon     = 305 #plus 8 more for the other divisions  ## CC-D begin: 300->305...
slot_team_d0_order_shield     = 314 #plus 8 more for the other divisions
slot_team_d0_order_skirmish   = 323 #plus 8 more for the other divisions
slot_team_d0_order_volley     = 332 #plus 8 more for the other divisions
slot_team_d0_order_sp_brace   = 341 #plus 8 more for the other divisions  ## CC-D end
...
keys_list = [ 
	          ...
	          #("$key_special_1", key_m), #Whistle for Horse 	## CC-D del
