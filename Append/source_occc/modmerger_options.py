...
# insert the active mod names here
	"freelancer",   # taragoth's Freelancer v1.51
	"pbod",         # Caba'drin's Pre-Battle Orders & Deployment v0.91
	"formations",   # motomataru's formations v4beta    
	"formAI",       # motomataru's formations v4beta AI extension.
	"lavco",        # Lav's Companion Overseer 1.20
	#"AgeOfMachinery",       # Age of Machinery occc addition
	"asmes",        # Advanced Soldier Management in Exchange Screens by Leonion
