...
# __Freelancer Report: Commander_:Start_________________________________________________
  ...
  ("taragoth_lords_report", 0, mesh_load_window, [
	...
	[
		...
		## NMCml FL begin: fix symbol size
		(position_set_x, pos1, 120),  ## 180->120
		(position_set_y, pos1, 100),  ##  80->100
		(overlay_set_position, reg0, pos1),
		(position_set_x, pos1, 300),  ## 600->300
		(position_set_y, pos1, 300),  ## 600->300
		(overlay_set_size, reg0, pos1),
		## NMCml FL end
