...
####################################################################################################################################
        ...
        [
            ...
            (try_for_range, ":slot_id", num_equipment_kinds, ":capacity"),
                ...
                (else_try),
                    ...
                    ## NMCml LCO begin: item amount fix
        ...
        [
            ...
            (try_begin),
                ...
                (try_for_range, reg0, 0, ":total_stacks"),
					...
					(neq,":troop_id","trp_npc25"),#occc Nonexistent Knight Agilulfo
            ...
            (try_begin),
                ...
                (try_for_range, ":troop_id", active_npcs_begin, active_npcs_end),
                    ## NMCml LCO begin: other kingodom hero fix
                    (store_troop_faction, ":cur_fuction", ":troop_id"),
                    (eq, ":cur_fuction", "$players_kingdom"),
                    ## NMCml LCO end
    ...
    ("cf_lco_controllable",
        [
            (store_script_param_1, ":troop_id"),
            (this_or_next|is_between, ":troop_id", customizable_troops_begin, customizable_troops_end),  ## CC-D add: allow to controll custom troop
            ...
            (else_try),
                ...
                (assign, ":control", 1),
            ## CC-D begin: allow to controll custom troop
            (else_try),
                (gt, "$g_lco_heroes", 0),
                (is_between, ":troop_id", customizable_troops_begin, customizable_troops_end),
                (neq, "$g_ccd_no_use_cave_custom_equip", 0),
                (assign, ":control", 1),
            ## CC-D end
            (try_end),
            (eq, ":control", 1),
    ...
    ("lco_troop_name_to_s40",
        [
            (store_script_param_1, ":troop_id"),
            (try_begin),
                (this_or_next|is_between, ":troop_id", customizable_troops_begin, customizable_troops_end),  ## CC-D add: get custom troop's custom name
