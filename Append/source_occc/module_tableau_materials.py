...
## CC-D begin
  ("gusoku_aka_sashi_long", 0, "sample_shield_matte", 512, 512, 0, 0, 0, 0,
   [
       (store_script_param, ":banner_mesh", 1),
       ...
       (cur_tableau_add_mesh, ":banner_mesh", pos1, 32, 0),
       (init_position, pos1),
       (position_set_z, pos1, 10),
       (cur_tableau_add_mesh, "mesh_tableau_mesh_gusoku_aka_sashi_long", pos1, 0, 0),
       (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       ]),
  ("gusoku2_ashi_sashi_long", 0, "sample_shield_matte", 512, 512, 0, 0, 0, 0,
   [
       (store_script_param, ":banner_mesh", 1),
       ...
       (init_position, pos1),
       (position_set_z, pos1, 10),
       (cur_tableau_add_mesh, "mesh_tableau_mesh_gusoku2_ashi_sashi_long", pos1, 0, 0),
       (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       ]),
## CC-D end
##occc starts

  ("long_surcoat_new_heraldic", 0, "sample_mail_long_surcoat_heraldic_new", 512, 512, 0, 0, 0, 0,
   [
       (store_script_param, ":banner_mesh", 1),
...
#       (cur_tableau_add_mesh, "mesh_banner_a01", pos1, 116, 0),
  ...
  ("brigandine_b_heraldic", 0, "sample_brigandine_b_heraldic", 512, 512, 0, 0, 0, 0,
   [
       (store_script_param, ":banner_mesh", 1),
...
#       (cur_tableau_add_mesh, "mesh_banner_a01", pos1, 116, 0),
  ...
  ("heraldic_tunic_new", 0, "sample_heraldic_tunic_new", 512, 512, 0, 0, 0, 0,
   [
       (store_script_param, ":banner_mesh", 1),
...
#       (cur_tableau_add_mesh, "mesh_banner_a01", pos1, 116, 0),
  ...
  ("surcoat_over_mail_short", 0, "sample_heraldic_surcoat_over_mail_short", 512, 512, 0, 0, 0, 0,
   [
       (store_script_param, ":banner_mesh", 1),
