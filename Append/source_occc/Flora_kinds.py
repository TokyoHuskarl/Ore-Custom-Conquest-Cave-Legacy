...
fauna_kinds = [
  ...
  ("rock",fkf_plain|fkf_align_with_ground|fkf_plain_forest|fkf_steppe|fkf_steppe_forest|fkf_realtime_ligting|fkf_rock|density(50),[["rock1","bo_rock1"],["rock2","bo_rock2"],["rock3","bo_rock3"],["rock4","bo_rock4"],["rock5","bo_rock5"],["rock7","bo_rock7"]]),  ## NMCml NativeFix: bo_rock6->bo_rock5
  ...
  ("tree_new_1",fkf_plain|fkf_plain_forest|fkf_steppe|fkf_steppe_forest|fkf_tree|density(4),[("tree_a01","bo_tree_a01",("0","0")),("tree_a02","bo_tree_a02",("0","0"))]),  ## NMCml NativeFix: bo_tree_a01->bo_tree_a02
...
## NMCml NativeAdFix begin: scene fix: hide flags: fkf_plain|fkf_plain_forest|fkf_steppe|fkf_steppe_forest|fkf_tree|density(4)
  ("chestnut",density(0),[("chestnut_old","bo_chestnut",("0","0"))]),
  ("oak",density(0),[("oak_a_old","bo_oak_a",("0","0")),("oak_b_old","bo_oak_b",("0","0"))]),
  ("pine",density(0),[("pine","bo_pine",("0","0")),("pine_b","bo_pine_b",("0","0"))]),
  ("tree_2",density(0),[("tree_2_a_old","bo_tree_2_a",("0","0")),("tree_2_b_old","bo_tree_2_b",("0","0"))]),
