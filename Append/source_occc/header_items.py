...
## CC
itc_spear         = itc_parry_polearm| itcf_thrust_onehanded_lance |itcf_thrust_onehanded_lance_horseback | itcf_thrust_polearm  ## CC-D fix: none(native)->itcf_overswing_spear(CC)->none
...
itc_pike          = itcf_thrust_onehanded_lance |itcf_thrust_onehanded_lance_horseback | itcf_thrust_polearm | itcf_overswing_polearm  ## CC-D fix: none(native)->itcf_overswing_spear(CC)->itcf_overswing_polearm
## CC

##occc itcf_overswing_musket
itc_spear_new =  itc_parry_polearm|itcf_thrust_onehanded_lance|itc_spear|itcf_force_64_bits|itcf_overswing_spear|itcf_overswing_musket|itcf_slashleft_polearm|itcf_slashright_polearm|itcf_thrust_onehanded_lance_horseback
##occc
...
itc_musket_melee = itc_parry_polearm|itcf_overswing_spear|itcf_thrust_musket|itcf_slashright_twohanded|itcf_slashleft_twohanded#occc itcf_overswing_polearm -> itcf_overswing_spear
## CC-D begin
itc_musket_melee_ccd = itc_parry_polearm|itcf_overswing_polearm|itcf_thrust_onehanded_lance|itcf_thrust_onehanded_lance_horseback|itcf_thrust_polearm|itcf_slashright_twohanded|itcf_slashleft_twohanded
## CC-D end
