...
mtf_sit_lords_hall                     = 0x02000000  ## CC-D
mtf_module_track                       = 0x10000000 ##set this flag for tracks placed under module folder

#test
mtf_culture_japan = mtf_sit_tavern
#mtf_culture_poland = mtf_sit_town
mtf_culture_aztec = mtf_sit_town_infiltrate
mtf_culture_roman = mtf_sit_night
mtf_culture_grandearmee = mtf_sit_day
mtf_culture_dark = mtf_sit_encounter_hostile
