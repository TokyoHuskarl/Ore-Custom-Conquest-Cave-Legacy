...
#CC-C begin
 ("ccc_hard_core","Hard Core Mode", qf_random_quest,"hard core mode now"),
 ("ccc_cave_quest1", "{!}{s10}", qf_random_quest,"{!}{s11}",),
 ("ccc_cave_quest2", "{!}{s10}", qf_random_quest,"{!}{s11}",),
 ("ccc_cave_quest3", "{!}{s10}", qf_random_quest,"{!}{s11}",),
 ("ccc_cave_quest4", "{!}{s10}", qf_random_quest,"{!}{s11}",),
 ("ccc_cave_quest5", "{!}{s10}", qf_random_quest,"{!}{s11}",),
 ("ccc_cave_quest6", "{!}{s10}", qf_random_quest,"{!}{s11}",),
 ("ccc_cave_quest7", "{!}{s10}", qf_random_quest,"{!}{s11}",),
 ("ccc_cave_quest8", "{!}{s10}", qf_random_quest,"{!}{s11}",),
 ("ccc_cave_quest9", "{!}{s10}", qf_random_quest,"{!}{s11}",),
 ("ccc_cave_quest10", "{!}{s10}", qf_random_quest,"{!}{s11}",),
 ("ccc_cave_quest_end", "{!}{s10}", qf_random_quest,"{!}{s11}",),
#CC-C end

  ## CC begin
  ("deal_with_forest_bandit", "Deal with the leader of forest bandits", 0,
  "{!}The guildmaster of {s4} has asked you to deal with the leader of the forest bandits."
  ),
  ("deal_with_taiga_bandit", "Deal with the leader of taiga bandits", 0,
  "{!}The guildmaster of {s4} has asked you to deal with the leader of the taiga bandits."
  ),
  ("deal_with_steppe_bandit", "Deal with the leader of steppe bandits", 0,
  "{!}The guildmaster of {s4} has asked you to deal with the leader of the steppe bandits."
  ),
  ("deal_with_sea_raider", "Deal with the leader of sea raiders", 0,
  "{!}The guildmaster of {s4} has asked you to deal with the leader of the sea raiders."
  ),
  ("deal_with_mountain_bandit", "Deal with the leader of mountain bandits", 0,
  "{!}The guildmaster of {s4} has asked you to deal with the leader of the mountain bandits."
  ),
  ("deal_with_desert_bandit", "Deal with the leader of desert bandits", 0,
  "{!}The guildmaster of {s4} has asked you to deal with the leader of the desert bandits."
  ),
  ## CC end
...
# #bounty chief
 # ("bounty_1", "Hunt down {s4}", qf_random_quest,
  # "The {s9} of {s14} asked you to hunt down the fugitive named {s4}. He is currently believed to be at {s3}."
  # ),
