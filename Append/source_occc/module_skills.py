...
skills = [
  ...
  ("leadership","Leadership",sf_base_att_cha,15,"Every point increases maximum number of troops you can command by 5, increases your party morale and reduces troop wages by 5%%. (Leader skill)"),  ##CC-C: 10->15
  ("prisoner_management", "Prisoner Management",sf_base_att_cha,15,"Every level of this skill increases maximum number of prisoners by %d. (Leader skill)"),   ##CC-C: 10->15
  ("performing","Performing",sf_base_att_cha|sf_effects_party,15,"Every point increases your party's morale, besides this skill can improve its owner's relationship with other characters. However this skill has relatively minor importance. (Party skill)"), 
  ...
  ("spotting","Spotting",sf_base_att_int|sf_effects_party,15,"Party seeing range is increased by 10%% per skill level. (Party skill)"),  ##CC-C: 10->15
  ("pathfinding","Path-finding",sf_base_att_int|sf_effects_party,15,"Party map speed is increased by 3%% per skill level. (Party skill)"),   ##CC-C: 10->15
  ("tactics","Tactics",sf_base_att_int|sf_effects_party,15,"Every two levels of this skill increases starting battle advantage by 1. (Party skill)"),  ##CC-C: 10->15
  ("tracking","Tracking",sf_base_att_int|sf_effects_party,15,"Tracks become more informative. (Party skill)"),  ##CC-C: 10->15
  ("trainer","Trainer",sf_base_att_int,15,"Every day, each hero with this skill adds some experience to every other member of the party whose level is lower than his/hers. Experience gained goes as: {0,4,15,16,23,30,38,46,55,65,80}. (Personal skill)"),  ##CC-C: 10->15
  ...
  ("looting","Looting",sf_base_att_agi|sf_effects_party,15,"This skill increases the amount of loot obtained by 10%% per skill level. (Party skill)"),  ##CC-C: 10->15
  ...
  ("athletics","Athletics",sf_base_att_agi,15,"Improves your running speed. (Personal skill)"),#occc 10->15
  ...
  ("power_draw","Power Draw",sf_base_att_str,15,"Lets character use more powerful bows. Each point to this skill (up to four plus power-draw requirement of the bow) increases bow damage by 14%%. (Personal skill)"),  ##CC-C: 10->15
  ("power_throw","Power Throw",sf_base_att_str,15,"Each point to this skill increases throwing damage by 10%%. (Personal skill)"),  ##CC-C: 10->15
  ("power_strike","Power Strike",sf_base_att_str,15,"Each point to this skill increases melee damage by 8%%. (Personal skill)"),  ##CC-C: 10->15
  ("ironflesh","Ironflesh",sf_base_att_str,15,"Each point to this skill increases hit points by +2. (Personal skill)"),   ##CC-C: 10->15
