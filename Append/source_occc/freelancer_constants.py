...
freelancer_can_use_item  = "script_troop_can_use_item"    ## NMCml FL: individual script
#with Diplomacy: 
#freelancer_can_use_item = "script_dplmc_troop_can_use_item"
#freelancer_can_use_item  = "script_fl_troop_can_use_item"   ## NMCml FL: individual script
...
slot_freelancer_last_banner = slot_town_prosperity #only used for freelancer_party_backup  ## NMCml FL: keep banner

#Faction Slot
slot_faction_freelancer_troop = 101 #should be unused
slot_faction_fl_last_relation = 102  ## NMCml FL: keep relation
