...
#  ("killed_by_vaegir", "killed_by_vaegir.ogg", mtf_persist_until_finished|mtf_culture_2|mtf_sit_killed, 0),
  ...
  ("lords_hall_khergit", "lords_hall_khergit.ogg", mtf_culture_3|mtf_sit_travel|mtf_sit_lords_hall, mtf_sit_town|mtf_sit_night|mtf_sit_tavern|mtf_culture_all|mtf_sit_lords_hall),  ## CC-D mtf_sit_lords_hall
  ("lords_hall_nord", "lords_hall_nord.ogg", mtf_culture_4|mtf_sit_travel|mtf_sit_lords_hall, mtf_sit_town|mtf_sit_night|mtf_sit_tavern|mtf_sit_lords_hall),  ## CC-D mtf_culture_4, mtf_sit_lords_hall
  ("lords_hall_swadian", "lords_hall_swadian.ogg", mtf_culture_1|mtf_sit_travel|mtf_sit_lords_hall, mtf_sit_town|mtf_sit_night|mtf_sit_tavern|mtf_sit_lords_hall),  ## CC-D mtf_culture_1, mtf_sit_lords_hall
  ("lords_hall_rhodok", "lords_hall_rhodok.ogg", mtf_culture_5|mtf_sit_travel|mtf_sit_lords_hall, mtf_sit_town|mtf_sit_night|mtf_sit_tavern|mtf_sit_lords_hall),  ## CC-D mtf_culture_5, mtf_sit_lords_hall
  ("lords_hall_vaegir", "lords_hall_vaegir.ogg", mtf_culture_2|mtf_sit_travel|mtf_sit_lords_hall, mtf_sit_town|mtf_sit_night|mtf_sit_tavern|mtf_sit_lords_hall),  ## CC-D mtf_culture_2, mtf_sit_lords_hall
  ...
  ("victorious_swadian", "victorious_swadian.ogg", mtf_persist_until_finished|mtf_culture_1|mtf_sit_victorious, 0),
  ...
  ## CC-D begin
  ("ambushed_by_darkknight",  "ambushed.mp3", mtf_sit_ambushed|mtf_sit_siege|mtf_module_track, mtf_sit_fight|mtf_sit_multiplayer_fight|mtf_culture_all),
  ("fight_ex", "triumph.mp3", mtf_sit_fight|mtf_sit_multiplayer_fight|mtf_sit_ambushed|mtf_module_track, mtf_culture_all),
  ("fight_as_darkknight", "alosingbattle.mp3", mtf_sit_fight|mtf_sit_multiplayer_fight|mtf_module_track, mtf_culture_all),
  ("lords_hall", "thegreathall.mp3", mtf_sit_travel|mtf_sit_feast|mtf_module_track|mtf_sit_lords_hall, mtf_sit_town|mtf_sit_night|mtf_sit_feast|mtf_sit_lords_hall),
  ("lords_hall_2", "reluctanthero.mp3", mtf_sit_feast|mtf_module_track, mtf_sit_town|mtf_sit_night|mtf_sit_feast),
  ("warband_siege", "warband_siege.ogg", mtf_sit_siege, mtf_sit_fight|mtf_sit_multiplayer_fight|mtf_sit_ambushed),
  ("town_darkknight", "silentintruder.mp3", mtf_sit_town|mtf_sit_travel|mtf_module_track, mtf_sit_tavern|mtf_sit_night|mtf_culture_all),
  ("travel_darkknight",  "thepilgrimage.mp3",  mtf_sit_travel|mtf_module_track, mtf_sit_town|mtf_sit_tavern|mtf_culture_all),
  ("travel_darkknight_night",  "requiem.mp3",  mtf_sit_travel|mtf_sit_night|mtf_module_track, mtf_sit_town|mtf_sit_tavern|mtf_sit_travel|mtf_sit_night|mtf_culture_all),
  ## CC-D end

  ##occc begin
  
  
  #musics for battle against heroes and extra factions 
  ("fight_against_dragonborn", "fight_against_dragonborn.ogg", mtf_module_track,mtf_sit_fight|mtf_sit_multiplayer_fight|mtf_culture_all|mtf_sit_ambushed),
  ("fight_against_factional_heroes", "fight_against_factional_heroes.ogg", mtf_module_track,mtf_sit_fight|mtf_sit_multiplayer_fight|mtf_culture_all|mtf_sit_ambushed),
  ("fight_against_risingsun_1", "fight_against_risingsun_1.ogg", mtf_module_track,mtf_sit_fight|mtf_sit_multiplayer_fight|mtf_culture_all|mtf_sit_ambushed),
  ("fight_against_risingsun_2", "fight_against_risingsun_2.ogg", mtf_module_track,mtf_sit_fight|mtf_sit_multiplayer_fight|mtf_culture_all|mtf_sit_ambushed),
  ("fight_against_spartan", "fight_against_spartan.ogg", mtf_module_track,mtf_sit_fight|mtf_sit_multiplayer_fight|mtf_culture_all|mtf_sit_ambushed),
  ("fight_against_sunset", "fight_against_sunset.ogg", mtf_module_track,mtf_sit_fight|mtf_sit_multiplayer_fight|mtf_culture_all|mtf_sit_ambushed),
  ("fight_against_grandearmee", "fight_against_grandearmee.ogg", mtf_module_track,mtf_sit_fight|mtf_sit_multiplayer_fight|mtf_culture_all|mtf_sit_ambushed),#
  ("fight_against_viking_king", "fight_against_viking_king.ogg", mtf_module_track,mtf_sit_fight|mtf_sit_multiplayer_fight|mtf_culture_all|mtf_sit_ambushed),
  ("fight_against_mamluk", "fight_against_mamluk.ogg", mtf_module_track,mtf_sit_fight|mtf_sit_multiplayer_fight|mtf_culture_all|mtf_sit_ambushed),
  ("fight_against_teutonic_knights", "fight_against_teutonic_knights.ogg", mtf_module_track,mtf_sit_fight|mtf_sit_multiplayer_fight|mtf_culture_all|mtf_sit_ambushed),
  ("fight_against_roman_heroes", "fight_against_roman_heroes.ogg", mtf_module_track,mtf_sit_fight|mtf_sit_multiplayer_fight|mtf_culture_all|mtf_sit_ambushed),
  ("fight_against_british_redcoats", "fight_against_british_redcoats.ogg", mtf_module_track,mtf_sit_fight|mtf_sit_multiplayer_fight|mtf_culture_all|mtf_sit_ambushed),

  ##occc additional general musics
  ("occc_travel", "occc_field_travel.ogg", mtf_sit_travel|mtf_module_track, mtf_sit_town|mtf_sit_tavern|mtf_sit_night|mtf_culture_all),
