...
## CC-D end
## NMCml begin: game_missile_dives_into_water
...
## NMCml end
#CC-C begin
   ("game_blood_3", psf_billboard_3d | psf_randomize_size|psf_randomize_rotation ,  "prt_mesh_blood_3",
     2000, 0.6, 3, 0.3, 0, 0,        #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.0, 0.25), (0.7, 0.1),        #alpha keys
     (0.1, 0.7), (1, 0.7),      #red keys
     (0.1, 0.7), (1, 0.7),       #green keys
     (0.1, 0.7), (1, 0.7),      #blue keys
     (0.0, 0.15),   (3, 0.35),    #scale keys
     (0.01, 0.2, 0.01),             #emit box size
     (0.2, 0.3, 0),                 #emit velocity
     0.3,                         #emit dir randomness
     150,                       #rotation speed
   ...
   ("bullet_dust", psf_billboard_3d, "prtcl_dust_a",
    ...
    ("explosive_explosion_sparks_a", psf_billboard_3d|psf_randomize_size,  "prt_sparks_mesh_1",
     200, 0.15, 0.4, 0.2, 3, 10,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
   ...
   ("explosive_explosion_sparks_b", psf_billboard_3d|psf_randomize_size,  "prt_sparks_mesh_1",
     200, 0.3, 0.4, 0.2, 3, 10,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.6, 1), (0.7, 0),          #alpha keys
     (1.0, 1.0), (1, 0),      #red keys
...
## CC-D end
## CC-D begin: gun fire refer from Napoleonic Wars
    ("pistol_flash", psf_billboard_3d | psf_randomize_size , "prt_sparks_mesh_1",
     100, 0.8, 0.1, -0.00003, 50.0, 1.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.1, 0.8), (1, 0),        #alpha keys
     (0.5, 1.0), (1, 0.9),      #red keys
     (0.5, 0.6), (1, 0.1),      #green keys
     (0.5, 0.2), (1, 0.0),      #blue keys
    ...
    ("musket_flash", psf_billboard_3d | psf_randomize_size , "prt_sparks_mesh_1",
     300, 0.8, 0.1, -0.00003, 50.0, 1.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.1, 0.8), (1, 0),        #alpha keys
     (0.5, 1.0), (1, 0.9),      #red keys
     (0.5, 0.6), (1, 0.1),      #green keys
     (0.5, 0.2), (1, 0.0),      #blue keys
...
## CC-D end
## CC-D begin: explosion effect refer from Napoleonic Wars
    ("explosion_flash", psf_billboard_3d | psf_randomize_size , "prt_sparks_mesh_1",
     400, 0.8, 0.1, -0.00003, 50.0, 1.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.1, 0.8), (1, 0),        #alpha keys
     (0.5, 1.0), (1, 0.9),      #red keys
     (0.5, 0.6), (1, 0.1),      #green keys
     (0.5, 0.2), (1, 0.0),      #blue keys
     (0.1, 7.1),   (1.0, 0.2),   #scale keys
     (1.5, 1.5, 2.0),           #emit box size
   ...
   ("explosion_smoke2", psf_billboard_3d|psf_randomize_size,  "prtcl_dust_a",
     400, 6, 15, -0.04, 10.0, 0.2,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.1, 0.5), (1, 0),        #alpha keys
     (0.1, 0.8), (1, 0.8),      #red keys
     (0.1, 0.7),(1, 0.7),       #green keys
     (0.1, 0.6), (1, 0.7),      #blue keys
...
## CC-D end
## CC-D begin: sword effect
    ("ccd_light_spark", psf_billboard_3d|psf_global_emit_dir|psf_always_emit|psf_randomize_size,  "prt_sparks_mesh_1",
     10, 0.5, 0, 0, 0, 0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.5, 1), (1, 0),          #alpha keys
 #    (0.5, 0.3), (1, 0.3),      #red keys
 #    (0.5, 0.3), (1, 0.3),       #green keys
 #    (0.5, 1), (1, 1),      #blue keys
##ore custom
     (0.5, 1), (1, 1),      #red keys
     (0.5, 0.3), (1, 0.3),       #green keys
     (0.5, 0.3), (1, 0.3),      #blue keys
     (0, 0.3),   (0, 0.3),  #scale keys
     (0, 0, 0),           #emit box size
     (0, 0, 0),               #emit velocity
     0,                       #emit dir randomness
     0,                       #rotation speed
    ...
    ("ccd_light_spark_b", psf_billboard_3d|psf_global_emit_dir|psf_always_emit|psf_randomize_size,  "prt_sparks_mesh_1",
     10, 0.5, 0, 0, 0, 0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.5, 1), (1, 0),          #alpha keys
     (0.5, 0.3), (1, 0.3),      #red keys
     (0.5, 0.5), (1, 0.5),       #green keys
    ...
    ("ccd_light_spark_g", psf_billboard_3d|psf_global_emit_dir|psf_always_emit|psf_randomize_size,  "prt_sparks_mesh_1",
     10, 0.5, 0, 0, 0, 0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.5, 1), (1, 0),          #alpha keys
 #    (0.5, 0.3), (1, 0.3),      #red keys
 #    (0.5, 0.3), (1, 0.3),       #green keys
...
## CC-D end
## CC-D begin: rising aura
     ("ccd_rising_aura", psf_billboard_3d|psf_global_emit_dir|psf_always_emit|psf_randomize_size, "prt_sparks_mesh_1",
     300, 3, 0.2, 0, 5, 10,            #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.5, 1), (1, 0.0),            #alpha keys
     (0.5, .5), (1, 0.5),           #red keys
     (0.5, 0.7), (1, 0.7),          #green keys
     (0.5, 1), (1, 1),              #blue keys
...
## CC-D begin: tracer
    ("ccd_tracer_light", psf_billboard_3d|psf_global_emit_dir|psf_always_emit|psf_randomize_size,  "prt_sparks_mesh_1",
     50, 0.5, 0.2, 0, 0, 0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.1, 0.2), (1, 0.4),          #alpha keys
     (0.5, 0.8), (1, 0.6),      #red keys
     (0.5, 0.6), (1, 0.2),       #green keys
     (0.5, 0.1), (1, 0.0),      #blue keys
     (0, 0.3),   (0.4, 0.6),  #scale keys
     (0, 0, 0),           #emit box size
     (0, 0, 0),               #emit velocity
     0,                       #emit dir randomness
...
# Required:
	...
	#Project Age Of Machinery start-----------------------------------------------
     ("cannon_ground_hit", psf_billboard_2d|psf_randomize_size|psf_randomize_rotation|psf_2d_turbulance, "prt_mesh_mud_1",#prt_mesh_dust_1
     90, .7,  10, 3, 0, 0, #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0, 1.0), (1, 1.0),        #alpha keys
     (0, .7), (1, .7),        #red keys
     (0, 0.6),(1, 0.6),         #green keys
     (0, 0.4),(1, 0.4),         #blue keys
     (0.0, 0.2),   (1.0, 0.33),   #scale keys
     (0.15, 0.5, 0.1),           #emit box size
     (0, 0, 15),                 #emit velocity
     6,                         #emit dir randomness
     200,                       #rotation speed
     ...
     ("cannon_ground_hit_b", psf_billboard_3d|psf_randomize_size|psf_randomize_rotation|psf_2d_turbulance, "prt_mesh_dust_1",#prt_mesh_dust_1
     45, 2.0,  10, 0.05, 10.0, 39.0, #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.2, 0.5), (1, 0.0),        #alpha keys
     (0, 0.25), (1, 0.25),        #red keys
     (0, 0.23),(1, 0.23),         #green keys
     (0, 0.2),(1, 0.2),         #blue keys
     (0.0, 2.0),   (1.0, 3.5),   #scale keys
     (0.2, 0.6, 0.4),           #emit box size
     (0, 0, 3.9),                 #emit velocity
     0.5,                         #emit dir randomness
     130,                       #rotation speed
     0.5                        #rotation damping
    ),
     ("cannon_ground_hit_b_large", psf_billboard_3d|psf_randomize_size|psf_randomize_rotation|psf_2d_turbulance, "prt_mesh_dust_1",#prt_mesh_dust_1
     45, 2.0,  10, 0.05, 10.0, 39.0, #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.2, 0.5), (1, 0.0),        #alpha keys
     (0, 0.25), (1, 0.25),        #red keys
     (0, 0.23),(1, 0.23),         #green keys
     (0, 0.2),(1, 0.2),         #blue keys
     (0.0, 4.0),   (1.0, 7),   #scale keys
     (0.2, 0.6, 0.4),           #emit box size
     (0, 0, 3.9),                 #emit velocity
     5,                         #emit dir randomness
     130,                       #rotation speed
    ...
    ("cannon_smoke", psf_billboard_3d, "prtcl_dust_a",
     10, 3.75, 0.6, -0.2, 60.0, 1.5,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.0, 1.0), (1, 0.3),       #alpha keys
     (0.0, 0.7), (1, 0.4),      #red keys
     (0.0, 0.7),(1, 0.4),       #green keys
     (0.0, 1.0), (1, 0.6),      #blue keys
     (0, 4.5),   (0.5, 33.0),   #scale keys
     (0.1, 0.1, 0.1),           #emit box size
     (2, 10, 0),                 #emit velocity
     0.1                        #emit dir randomness
    ),
    ("cannon_dust", psf_billboard_3d, "prtcl_dust_a",
     1, 5, 0.6, -0.2, 20.0, 0.6,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.0, 1.0), (1, 1.0),       #alpha keys
     (0.0, 0.7), (1, 0.4),      #red keys
     (0.0, 0.7),(1, 0.4),       #green keys
     (0.0, 1.0), (1, 0.6),      #blue keys
     (0, 150),   (0.5, 150),   #scale keys
     (15.1, 15.1, 15.1),           #emit box size
     (0, 0, 0),                 #emit velocity
     1.0                        #emit dir randomness
    ),
    ("pistol_dust", psf_billboard_3d, "prtcl_dust_a",
     1, 5, 0.6, -0.2, 10.0, 0.15,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.0, 1.0), (1, 1.0),       #alpha keys
     (0.0, 0.7), (1, 0.4),      #red keys
     (0.0, 0.7),(1, 0.4),       #green keys
     (0.0, 1.0), (1, 0.6),      #blue keys
     (0, 50),   (0.5, 50),   #scale keys
     (5.1, 5.1, 5.1),           #emit box size
     (0, 0, 0),                 #emit velocity
     0.3                        #emit dir randomness
    ),
    ("pistol_smoke_b", psf_billboard_3d, "prtcl_dust_a",
     30, 1.25, 0.6, -0.2, 60.0, 1.5,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
    ...
    ("explosion_fire", psf_billboard_3d|psf_global_emit_dir|psf_always_emit|psf_randomize_size|psf_randomize_rotation, "prt_mesh_fire_1",
     100, 0.2, 0, -1.2, 25.0, 10.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.2, 0.7), (1, 0),        #alpha keys
     (0.2, 1.0), (1, 0.9),      #red keys
     (0.2, 0.7),(1, 0.3),       #green keys
     (0.2, 0.2), (1, 0.0),      #blue keys
    ...
    ("broken_stones_a", psf_billboard_3d|psf_randomize_size|psf_randomize_rotation, "broken_stone_a",
     3, 9, 0.7, 0.9, 20.0, 0.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.3, 1.0), (1, 0.3),        #alpha keys
     (1.0, 1.0), (1, 1.0),      #red keys
     (1.0, 1.0), (1, 1.0),      #green keys
     (1.0, 1.0), (1, 1.0),      #blue keys
     (0.0, 1.0),   (1.0, 1.0),   #scale keys
     (0.4, 0.3, 0.1),           #emit box size
     (0, 1.3, 1.1),               #emit velocity
    ...
    ("broken_stones_b", psf_billboard_3d|psf_randomize_size|psf_randomize_rotation, "broken_stone_b",
     3, 9, 0.7, 0.9, 20.0, 0.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.3, 1.0), (1, 0.3),        #alpha keys
     (1.0, 1.0), (1, 1.0),      #red keys
     (1.0, 1.0), (1, 1.0),      #green keys
    ...
    ("broken_stones_c", psf_billboard_3d|psf_randomize_size|psf_randomize_rotation, "broken_stone_c",
     3, 9, 0.7, 0.9, 20.0, 0.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.3, 1.0), (1, 0.3),        #alpha keys
     (1.0, 1.0), (1, 1.0),      #red keys
     (1.0, 1.0), (1, 1.0),      #green keys
    ...
    ("occc_moonlight", psf_billboard_3d|psf_global_emit_dir|psf_always_emit|psf_randomize_size,  "prt_sparks_mesh_1",
     12, 0.5, 0.1, -0.1, 0, 0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.5, 1), (1, 0),          #alpha keys
     (0.5, 0.2), (1, 0.5),      #red keys
     (0.5, 0.6), (1, 0.9),       #green keys
     (0.5, 0.8), (1, 1),      #blue keys
     (0, 0.1),   (0, 0.1),  #scale keys
     (0, 0, 0),           #emit box size
     (0, 0, 0),               #emit velocity
     0.3,                       #emit dir randomness
     0,                       #rotation speed
