...
#occc start
 ["stand_single", 0, amf_client_prediction,
	...
	[9.0, "sword_loop02", 0, 200, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
	[9.0, "sword_loop03", 0, 200, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
	[9.0, "sword_loop04", 0, 200, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
	[9.0, "sword_loop05", 0, 200, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
	[9.0, "sword_loop06", 0, 200, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
	[9.0, "sword_loop07", 0, 200, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
 ...
 ["stand_greatsword", 0, amf_client_prediction,
   ...
   [6.0, "twohanded_01", 0, 91, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],  
   [6.0, "twohanded_02", 0, 91, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],  
   [6.0, "twohanded_03", 0, 91, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],  
 ...
 ["stand_staff", 0, amf_client_prediction,
   ...
   [2.0, "pike_loop01", 0, 60, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.0],  
   [2.0, "pike_loop02", 0, 60, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.0],  
   [2.0, "pike_loop03", 0, 60, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.0],  
 ],
#occc end
...
##   [1.09, "jump", 22, 48, arf_blend_in_1],
   ...
   #[1.0, "kick_rightleg_y3", 12, 33, arf_blend_in_1],  ## CC-D add
 ],
 ["kick_left_leg", acf_enforce_lowerbody, amf_priority_kick|amf_play|amf_client_prediction,
##   [1.09, "jump", 22, 48, arf_blend_in_1],
   #[0.7, "kick_rightleg", 12, 33, arf_blend_in_1],  ## CC-D del
   #[0.7, "kick_leftleg", 12, 33, arf_blend_in_1],  ## CC-D add
   [0.7, "kick_leftleg_y", 0, 23, arf_blend_in_1],  ## CC-D add
 ],
...
#   [0.8, "anim_human", 7000, 7040, arf_use_walk_progress|arf_cyclic|blend_in_walk,pack2f(0.4,0.9)], 
 ...
 #occc animation improvement begin
...
##   [1.0, "anim_human", 6100, 6120, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
   [1.0, "walk_pike_1", 0, 32, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
   [1.0, "walk_pike_2", 0, 32, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
   [1.0, "walk_pike_3", 0, 32, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
   [1.0, "walk_pike_4", 0, 32, arf_use_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
   ],
#occc end
...
##   [4.0, "anim_human", horse_move + 5000, horse_move + 5057, arf_lancer|arf_cyclic],
 ...
 ["equip_greatsword", 0, amf_priority_equip|amf_play|amf_restart|amf_client_prediction,
   ...
   #[1.2, "equip_greatsword_rotation_up", 3, 25, arf_blend_in_0],  ## CC-D add
 ],
 ...
 ["equip_spear", 0, amf_priority_equip|amf_play|amf_restart|amf_client_prediction,
   ...
   #[1.2, "equip_spear_rotation", 3, 25, arf_blend_in_0],  ## CC-D add
 ],
...
# duration and controlled via weapon speed.
 ...
 ["reload_crossbow", 0, amf_priority_reload|amf_use_weapon_speed|amf_play,
   ...
   #[1.5, "crossbow_reload_pavise", 0, 158, arf_blend_in_8|arf_make_custom_sound, pack2f(0.94, 0.4), (0, 0, 0), 0],  ## CC-D add
 ],
...
##   [1.0, "throw_stone", 21, 54, arf_blend_in_0],
 ...
 ["reload_pistol", 0, amf_priority_reload|amf_use_weapon_speed|amf_play,
   ...
   #[1.0, "reloadpistol", 0, 14, arf_blend_in_8],  ## CC-D
   ## CC-D end
 ],
 ["ready_musket", acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_keep|amf_client_owner_prediction|amf_rider_rot_crossbow,
   ## CC-D begin
   [1.5, "anim_human", combat+1300, combat+1320, blend_in_ready],
   #[1.5, "ready_musket", 2, 2, blend_in_ready],  ## CC-D from NW
   ## CC-D end
 ],
...
#CC-C begin
   #[2.0, "anim_human", combat+2650, combat+2860, arf_blend_in_8],
  [3.0, "rack_and_pinion_reload", 0, 256, arf_blend_in_8],
  #[1.0, "new_rifle_reload", 0, 224, arf_blend_in_8],  ## CC-D
#CC-C end
 ],
...
#occc combat animation improvement 
...
#CC-C begin
 #fuck femalenm
 ["fuck_female_1", 0, amf_play|amf_priority_die,
  [0.5, "fuck_female", 0, 10, arf_cyclic]],

 ["fuck_female_2", 0, amf_play|amf_priority_die,
  [0.5, "fuck_female_1", 0, 10, arf_cyclic]],

 ["fuck_female_3", 0, amf_play|amf_priority_die,
  [0.5, "fuck_female_2", 0, 10, arf_cyclic]],

 ["fuck_female_orgasm", 0, amf_play|amf_priority_die,
  [0.5, "fuck_female_orgasm", 0, 10, arf_cyclic]],

 #mount female
 ["mount_female_fucker_1", 0, amf_play|amf_priority_die,
  [0.5, "female_fucker", 1, 11, arf_cyclic]],
  
 ["mount_female_fucker_2", 0, amf_play|amf_priority_die,
  [0.5, "female_fucker_1", 1, 11, arf_cyclic]],
  
 ["mount_female_fucker_3", 0, amf_play|amf_priority_die,
  [0.5, "female_fucker_2", 1, 11, arf_cyclic]],
  
 #fuck male
 ["fuck_male_1", 0, amf_play|amf_priority_die,
  [0.5, "fuck_male", 0, 10, arf_cyclic]],

## CC-D begin: not use
# ["fuck_male_2", 0, amf_play|amf_priority_die,
#  [0.5, "fuck_male_1", 0, 10, arf_cyclic]],
## CC-D end

 ["fuck_male_orgasm", 0, amf_play|amf_priority_die,
  [0.5, "fuck_male_orgasm", 0, 10, arf_cyclic]],
 
 #mount male
 ["mount_male_fucked", 0, amf_play|amf_priority_die,
  [0.5, "male_fucked", 1, 11, arf_cyclic]],
  
  
 #dance
 ["dance_wedding", 0, amf_play|amf_priority_die,
  [10, "wedding_dance_male", 0, 110, arf_cyclic]],
  
 ["dancer_1", 0, amf_play|amf_priority_die,
  [1, "dancer", 0, 24, arf_cyclic]],
  
   ["dancer_2", 0, amf_play|amf_priority_die,
  [1, "dancer_1", 0, 20, arf_cyclic]],

 ["dancer_3", 0, amf_play|amf_priority_die,
  [1, "dancer_2", 0, 20, arf_cyclic]],

 ["dancer_4", 0, amf_play|amf_priority_die,
  [1, "dancer_3", 0, 18, arf_cyclic]],

 #jump
 ["flip", 0, amf_play|amf_priority_die,
  [1, "jester_flip", 0, 25, arf_cyclic]],

## CC-D begin: not use
# ["spring", 0, amf_play|amf_priority_die,
#  [4, "jester_handspring", 0, 50, arf_cyclic]],
##CC-D end
 ...
 ["defend_shield_keep_crouch", acf_parallels_for_look_slope|acf_anim_length(100), amf_rider_rot_shield|amf_priority_defend_parry|amf_keep|amf_rider_rot_defend|amf_client_owner_prediction,
   [1, "defend_shield_y2", 42, 42, arf_blend_in_4|arf_cyclic], 
 ],
 
 ["end", acf_parallels_for_look_slope|acf_anim_length(100), amf_rider_rot_shield|amf_priority_die|amf_rider_rot_defend|amf_client_owner_prediction,
   [0.1, "defend_shield_y2", 0, 0, arf_blend_in_4], 
 ],
 
## CC-D begin
# ["spring_jump", acf_enforce_lowerbody, amf_priority_jump|amf_play|amf_client_prediction|amf_continue_to_next,
#   [1.0, "jester_handspring", 0, 30, arf_blend_in_1],
# ],
## Shield Bash 
 ["shield_bash_c09", acf_enforce_all|acf_align_with_ground, amf_priority_striked|amf_play|amf_accurate_body|amf_restart,
    #[0.50, "defend_shield_parry_all", 1, 50, blend_in_defense], #Adjust duration for balance.  Currently at 0.50 seconds, fixed.
    #[0.50, "defend_shield_right_y", 1, 50, blend_in_defense],
    #[0.50, "defend_shield_left", 1, 50, blend_in_defense],
    #[0.50, "defend_shield_right", 1, 50, blend_in_defense],
    [1.0, "shield_bash_k", 1, 37, blend_in_defense],
    #[1.5, "shield_bash_2", 1, 17, blend_in_defense],
],
["shield_strike_c09", acf_enforce_all|acf_align_with_ground, amf_priority_striked|amf_play|amf_accurate_body|amf_restart,
    [0.7, "anim_human", blow+5099, blow+5139, arf_blend_in_3|arf_make_custom_sound],  ## CC-D 1.0->0.7 5000->5099 5010->5139
...
## CC-D begin: add for dog
 ["horse_swingright", acf_enforce_all, amf_priority_striked|amf_play|amf_restart|amf_client_owner_prediction,
   [0.5, "anim_horse", 491, 508, blend_in_defense], 
 ],
 ["horse_swingleft", acf_enforce_all, amf_priority_striked|amf_play|amf_restart|amf_client_owner_prediction,
   [0.5, "anim_horse", 487, 492, blend_in_defense], 
 ],
 ["horse_overswing", acf_enforce_all, amf_priority_striked|amf_play|amf_restart|amf_client_owner_prediction,
   [0.5, "anim_horse", 662, 680, blend_in_defense], 
 ],
## CC-D end
## CC-D begin: extra wrestling
 #idle
 ["femal_idle_1", 0, 0,
  [20.2, "femal_idle_expect", 0, 500, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25]],

 ["expect_idle_back", 0, 0,
  [3.0, "femal_idle_expect.001", 0, 60, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25]],

 ["expect_idle_yoko", 0, 0,
  [2.0, "femal_idle_expect.002", 0, 40, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25]],

 ["expect_idle_close", 0, 0,
  [3.0, "femal_idle_expect.003", 0, 60, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25]],

 ["expect_idle_open", 0, 0,
  [3.0, "femal_idle_expect.003_2", 0, 60, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25]],

 ["expect_idle_legup", 0, 0,
  [3.0, "femal_idle_expect.004", 0, 60, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25]],

# ["expect_idle_1", 0, 0,
#  [16, "femal_idle_expect2SA", 0, 345, arf_cyclic]],

# ["expect_idle_2", 0, 0,
#  [1.5, "femal_idle_expect2.004", 0, 30, arf_cyclic]],

# ["expect_idle_5_1", 0, amf_play|amf_priority_die,
#  [1.5, "expect.004", 0, 30, arf_cyclic]],

 #intro
 ["expect_idle_6", 0, amf_play|amf_priority_die,
  [4.4, "femal_idle_expect2.005", 0, 100, arf_blend_in_1]],

 ["expect_idle_male", 0, amf_play|amf_priority_die,
  [4.4, "male_idle_expect2", 0, 100, arf_blend_in_1]],

 #fuck female
 ["ex_fuck_female_1", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_female", 0, 10, arf_cyclic]],

 ["ex_fuck_female_2", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_female_1", 0, 10, arf_cyclic]],

 ["ex_fuck_female_3", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_female_2", 0, 10, arf_cyclic]],

 ["ex_fuck_female_orgasm", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_female_orgasm", 0, 10, arf_cyclic]],

 #mount female
 ["ex_mount_female_fucker_1", 0, amf_play|amf_priority_die,
  [0.5, "ex_female_fucker", 1, 10, arf_cyclic]],

 ["ex_mount_female_fucker_2", 0, amf_play|amf_priority_die,
  [0.5, "ex_female_fucker_1", 1, 10, arf_cyclic]],

 ["ex_mount_female_fucker_3", 0, amf_play|amf_priority_die,
  [0.5, "ex_female_fucker_2", 1, 10, arf_cyclic]],

 #ground female
 ["ex_ground_female_fuck_1", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_female_m_1" , 0, 10, arf_cyclic]],

 ["ex_ground_female_fuck_2", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_female_m_2", 0, 10, arf_cyclic]],

 ["ex_ground_female_fuck_3", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_female_m_3", 0, 10, arf_cyclic]],

 ["ex_ground_female_fuck_4", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_female_m_4", 0, 10, arf_cyclic]],

 #dog female
 ["ex_dog_female_fuck_1", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_female_d_1" , 0, 10, arf_cyclic]],

 ["ex_dog_female_fuck_2", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_female_d_2", 0, 10, arf_cyclic]],

 ["ex_dog_female_fuck_3", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_female_d_3", 0, 10, arf_cyclic]],

 ["ex_dog_female_fuck_4", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_female_d_4", 0, 10, arf_cyclic]],

 ["ex_dog_female_fuck_5", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_female_d_5", 0, 10, arf_cyclic]],

 #love female
 ["ex_love_female_fuck_1", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_female_l_1" , 0, 10, arf_cyclic]],

 ["ex_love_female_fuck_2", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_female_l_2", 0, 10, arf_cyclic]],

 ["ex_love_female_fuck_3", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_female_l_3", 0, 10, arf_cyclic]],

 ["ex_love_female_fuck_4", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_female_l_4", 0, 10, arf_cyclic]],

 #sexy female
 ["ex_sexy_female_fuck_1", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_female_s_1" , 0, 10, arf_cyclic]],

 ["ex_sexy_female_fuck_2", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_female_s_2", 0, 10, arf_cyclic]],

 ["ex_sexy_female_fuck_3", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_female_s_3", 0, 10, arf_cyclic]],

 ["ex_sexy_female_fuck_4", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_female_s_4", 0, 10, arf_cyclic]],

 #ride female
 ["ex_ride_female_fuck_1", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_female_r_1" , 0, 10, arf_cyclic]],

 ["ex_ride_female_fuck_2", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_female_r_2" , 0, 10, arf_cyclic]],

 ["ex_ride_female_fuck_3", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_female_r_3" , 0, 10, arf_cyclic]],

 ["ex_ride_female_fuck_4", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_female_r_4" , 0, 10, arf_cyclic]],

 ["ex_ride_female_fuck_5", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_female_r_5" , 0, 10, arf_cyclic]],

 #fuck male
 ["ex_fuck_male_1", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_male", 0, 10, arf_cyclic]],

 ["ex_fuck_male_orgasm", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_male_orgasm", 0, 10, arf_cyclic]],
 
 #mount male
 ["ex_mount_male_fucked", 0, amf_play|amf_priority_die,
  [0.5, "ex_male_fucked", 1, 9, arf_cyclic]],

  #ground male
 ["ex_ground_male_fuck_1", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_male_3", 0, 9, arf_cyclic]],

 ["ex_ground_male_fuck_2", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_male_3_orgasm", 0, 7, arf_cyclic]],

  #dog male
 ["ex_dog_male_fuck_1", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_male_6", 0, 9, arf_cyclic]],

  #love male
 ["ex_love_male_fuck_1", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_male_7", 0, 9, arf_cyclic]],

 ["ex_love_male_fuck_orgasm", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_male_7_orgasm", 0, 7, arf_cyclic]],

  #sexy male
 ["ex_sexy_male_fuck_1", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_male_5", 0, 10, arf_cyclic]],

 ["ex_sexy_male_fuck_orgasm", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_male_5_orgasm", 0, 9, arf_cyclic]],

  #ride male
 ["ex_ride_male_fuck_1", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_male_8", 0, 9, arf_cyclic]],

  #ichaicha
 ["ex_icha_male_fuck_1", 0, amf_play|amf_priority_die,
  [0.5, "ex_male_fucked_01", 0, 9, arf_cyclic]],

 ["ex_icha_female_fuck_1", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_female_ichaicha_01", 0, 15, arf_cyclic]],

 ["ex_icha_female_fuck_2", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_female_ichaicha_02", 0, 15, arf_cyclic]],

 ["ex_icha_female_fuck_3", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_female_ichaicha_03", 0, 18, arf_cyclic]],

 ["ex_icha_female_fuck_4", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_female_ichaicha_04", 0, 15, arf_cyclic]],

 ["ex_icha_female_fuck_5", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_female_ichaicha_05", 0, 15, arf_cyclic]],

  #yoko
 ["ex_yoko_male_fuck_1", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_male_4", 0, 10, arf_cyclic]],

 ["ex_yoko_male_fuck_2", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_male_4_orgasm", 0, 9, arf_cyclic]],

 ["ex_yoko_female_fuck_1", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_female_y_1", 0, 10, arf_cyclic]],

 ["ex_yoko_female_fuck_2", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_female_y_2", 0, 10, arf_cyclic]],

 ["ex_yoko_female_fuck_3", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_female_y_3", 0, 10, arf_cyclic]],

 ["ex_yoko_female_fuck_4", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_female_y_4", 0, 10, arf_cyclic]],

 ["ex_yoko_female_fuck_5", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_female_y_5", 0, 10, arf_cyclic]],

  #haimen
 ["ex_haimen_female_fuck_1", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_female_h_1", 0, 10, arf_cyclic]],

 ["ex_haimen_female_fuck_2", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_female_h_2", 0, 10, arf_cyclic]],

 ["ex_haimen_female_fuck_3", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_female_h_3", 0, 10, arf_cyclic]],

 ["ex_haimen_female_fuck_4", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_female_h_4", 0, 10, arf_cyclic]],

 ["ex_haimen_female_fuck_5", 0, amf_play|amf_priority_die,
  [0.5, "ex_fuck_female_h_5", 0, 10, arf_cyclic]],

 ["ex_haimen_male_fuck_1", 0, amf_play|amf_priority_die,
  [0.5, "ex_male_fucked_02", 0, 10, arf_cyclic]],

 #fuck_come
  #ex-stand-1
 ["male_come_stand01", 0, amf_play|amf_priority_die,
  #[30, "ex_fuck_male_Experimental", 0, 511, arf_cyclic]],
  [28, "male_come_stand01", 0, 500, arf_cyclic]],

 ["female_come_stand01", 0, amf_play|amf_priority_die,
  #[30, "ex_fuck_female_Experimental", 0, 511, arf_cyclic]],
  [28, "female_come_stand01", 0, 500, arf_cyclic]],

  #ex-mount-1
 ["male_come_mount01", 0, amf_play|amf_priority_die,
  #[30, "ex_male_fucked_Experimental", 1, 540, arf_cyclic]],
  [28, "male_come_mount01", 1, 500, arf_cyclic]],

 ["female_come_mount01", 0, amf_play|amf_priority_die,
  #[30, "ex_female_fucker_Experimental", 0, 540, arf_cyclic]],
  [28, "female_come_mount01", 0, 500, arf_cyclic]],

  #ex-stand-2
 ["male_come_stand02", 0, amf_play|amf_priority_die,
  [28, "male_come_stand02", 0, 500, arf_cyclic]],

 ["female_come_stand02", 0, amf_play|amf_priority_die,
  [28, "female_come_stand02", 0, 500, arf_cyclic]],

  #ex-mount-2
 ["male_come_mount02", 0, amf_play|amf_priority_die,
  [28, "male_come_mount02", 1, 500, arf_cyclic]],

 ["female_come_mount02", 0, amf_play|amf_priority_die,
  [28, "female_come_mount02", 0, 500, arf_cyclic]],

  #ground
 ["male_come_seijyoui02", 0, amf_play|amf_priority_die,
  #[30, "ex_fuck_male_3_Experimental", 0, 550, arf_cyclic]],
  [28, "male_come_seijyoui02", 0, 500, arf_cyclic]],

 ["female_come_seijyoui02", 0, amf_play|amf_priority_die,
  #[30, "ex_fuck_female_m_Experimental", 0, 550, arf_cyclic]],
  [28, "female_come_seijyoui02", 0, 500, arf_cyclic]],

  #dog
 ["male_come_back01", 0, amf_play|amf_priority_die,
  #[30, "ex_fuck_male_6_Experimental", 0, 444, arf_cyclic]],
  [28, "male_come_back01", 0, 500, arf_cyclic]],

 ["female_come_back01", 0, amf_play|amf_priority_die,
  #[30, "ex_fuck_female_d_Experimental", 0, 444, arf_cyclic]],
  [28, "female_come_back01", 0, 500, arf_cyclic]],

  #love
 ["male_come_seijyoui01", 0, amf_play|amf_priority_die,
  #[30, "ex_fuck_male_7_Experimental", 0, 511, arf_cyclic]],
  [28, "male_come_seijyoui01", 0, 500, arf_cyclic]],

 ["female_come_seijyoui01", 0, amf_play|amf_priority_die,
  #[30, "ex_fuck_female_l_Experimental", 0, 511, arf_cyclic]],
  [28, "female_come_seijyoui01", 0, 500, arf_cyclic]],

  #sexy
 ["male_come_manguri01", 0, amf_play|amf_priority_die,
  #[25, "ex_fuck_male_5_Experimental", 0, 362, arf_cyclic]],
  [28, "male_come_manguri01", 0, 500, arf_cyclic]],

 ["female_come_manguri01", 0, amf_play|amf_priority_die,
  #[25, "ex_fuck_female_s_Experimental", 0, 362, arf_cyclic]],
  [28, "female_come_manguri01", 0, 500, arf_cyclic]],

  #ride
 ["male_come_taimenzai01", 0, amf_play|amf_priority_die,
  #[30, "ex_fuck_male_8_Experimental", 0, 511, arf_cyclic]],
  [28, "male_come_taimenzai01", 0, 500, arf_cyclic]],

 ["female_come_taimenzai01", 0, amf_play|amf_priority_die,
  #[30, "ex_fuck_female_r_Experimental", 0, 511, arf_cyclic]],
  [28, "female_come_taimenzai01", 0, 500, arf_cyclic]],

  #yoko
 ["male_come_yoko01", 0, amf_play|amf_priority_die,
  #[30, "ex_fuck_male_4_Experimental", 0, 479, arf_cyclic]],
  [28, "male_come_yoko01", 0, 500, arf_cyclic]],

 ["female_come_yoko01", 0, amf_play|amf_priority_die,
  #[30, "ex_fuck_female_y_Experimental", 0, 479, arf_cyclic]],
  [28, "female_come_yoko01", 0, 500, arf_cyclic]],

  #haimen
 ["male_come_haimen01", 0, amf_play|amf_priority_die,
  #[30, "ex_male_fucked_02_Experimental", 0, 390, arf_cyclic]],
  [28, "male_come_haimen01", 0, 500, arf_cyclic]],

 ["female_come_haimen01", 0, amf_play|amf_priority_die,
  #[30, "ex_fuck_female_h_Experimental", 0, 390, arf_cyclic]],
  [28, "female_come_haimen01", 0, 500, arf_cyclic]],
  ## CC-D end
...
#imported from difor 0.58 start
  ["command_charge_onehanded", 0, amf_play|amf_priority_jump,
   [1.5, "ccd_command_charge_onehanded", 5, 39, arf_blend_in_5],],
   
 ["roar", 0, amf_play|amf_priority_mount,
   [2.0, "man_cheer", 200, 289, arf_blend_in_5],
 ],

#imported from difor 0.58 end

#occc start
 ["vader_parry_head_1", 0, amf_priority_fall_from_horse|amf_play,
   [defend_parry_duration_1, "2h_highblock_26.9.10", 0, 5, arf_blend_in_1],
 ],
 ["vader_parry_low_1", 0, amf_priority_fall_from_horse|amf_play,
   [0.3, "anim_human", defend+320, defend+330, arf_blend_in_1],
 ],
 ["vader_parry_right_1", 0, amf_priority_fall_from_horse|amf_play,
   [defend_parry_duration_1, "2h_right_left_blocks_3.11.10", 0, 5, arf_blend_in_1],
 ],
 ["vader_parry_left_1", 0, amf_priority_fall_from_horse|amf_play,
   [defend_parry_duration_1, "2h_right_left_blocks_3.11.10", 10, 15, arf_blend_in_1],
 ],
 ["strike_knockback_rolling", acf_enforce_all|acf_align_with_ground|acf_displace_position, amf_priority_striked|amf_play|amf_accurate_body|amf_restart,
   [1.0, "strike_down_y2b", 4, 21, arf_blend_in_3,0,(0,-3,0),0],
 ],

 ["onehand_pole_chest_front", acf_enforce_all|acf_align_with_ground|acf_displace_position, amf_priority_striked|amf_play|amf_accurate_body|amf_restart,
   [0.8, "strikes3_chest", 3, 27, arf_blend_in_3,  0, (0, -0.25, 0.0)], 
 ],
 ["onehand_pole_abdomen_front", acf_enforce_all|acf_align_with_ground|acf_displace_position, amf_priority_striked|amf_play|amf_accurate_body|amf_restart,
   [0.9 * 1.0, "strikes3_abdomen", 4, 43, arf_blend_in_3,  0, (0, -0.25, 0.0)],
 ],
